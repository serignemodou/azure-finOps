 ...
 * ```
 */
export declare class HciExtension extends pulumi.CustomResource {
    /**
     ...
     */
    readonly autoUpgradeMinorVersionEnabled: pulumi.Output<boolean | undefined>;
    /**
