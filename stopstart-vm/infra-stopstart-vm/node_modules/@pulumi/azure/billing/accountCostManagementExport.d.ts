 ...
 * ```
 */
export declare class AccountCostManagementExport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountCostManagementExportState, opts?: pulumi.CustomResourceOptions): AccountCostManagementExport;
    /**
     ...
     */
    static isInstance(obj: any): obj is AccountCostManagementExport;
    /**
     ...
     */
    readonly exportDataOptions: pulumi.Output<outputs.billing.AccountCostManagementExportExportDataOptions>;
    /**
     * A `exportDataStorageLocation` block as defined below.
     */
    readonly exportDataStorageLocation: pulumi.Output<outputs.billing.AccountCostManagementExportExportDataStorageLocation>;
