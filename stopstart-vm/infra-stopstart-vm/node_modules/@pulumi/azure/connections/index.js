...
exports.getManagedApiOutput = exports.getManagedApi = exports.ApiConnection = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.ApiConnection = null;
utilities.lazyLoad(exports, ["ApiConnection"], () => require("./apiConnection"));
exports.getManagedApi = null;
exports.getManagedApiOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:connections/apiConnection:ApiConnection":
                return new exports.ApiConnection(name, undefined, { urn });
            default:
