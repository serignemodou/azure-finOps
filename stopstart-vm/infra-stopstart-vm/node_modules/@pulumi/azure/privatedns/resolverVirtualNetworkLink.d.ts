 ...
 * ```
 */
export declare class ResolverVirtualNetworkLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResolverVirtualNetworkLinkState, opts?: pulumi.CustomResourceOptions): ResolverVirtualNetworkLink;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResolverVirtualNetworkLink;
    /**
