 ...
 * ```
 */
export declare class MxRecord extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MxRecordState, opts?: pulumi.CustomResourceOptions): MxRecord;
    /**
     * Returns true if the given object is an instance of MxRecord.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MxRecord;
    /**
     ...
     */
    readonly records: pulumi.Output<outputs.privatedns.MxRecordRecord[]>;
    /**
