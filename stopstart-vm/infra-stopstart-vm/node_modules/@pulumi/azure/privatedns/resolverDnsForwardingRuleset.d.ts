 ...
 * ```
 */
export declare class ResolverDnsForwardingRuleset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResolverDnsForwardingRulesetState, opts?: pulumi.CustomResourceOptions): ResolverDnsForwardingRuleset;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResolverDnsForwardingRuleset;
    /**
     ...
     */
    readonly privateDnsResolverOutboundEndpointIds: pulumi.Output<string[]>;
    /**
