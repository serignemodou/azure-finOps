 ...
 * ```
 */
export declare class ResolverOutboundEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResolverOutboundEndpointState, opts?: pulumi.CustomResourceOptions): ResolverOutboundEndpoint;
    /**
     * Returns true if the given object is an instance of ResolverOutboundEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResolverOutboundEndpoint;
    /**
