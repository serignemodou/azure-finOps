 ...
 * ```
 */
export declare class Mover extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverState, opts?: pulumi.CustomResourceOptions): Mover;
    /**
     * Returns true if the given object is an instance of Mover.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Mover;
    /**
