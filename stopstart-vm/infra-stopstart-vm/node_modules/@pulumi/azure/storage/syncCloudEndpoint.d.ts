 ...
 * ```
 */
export declare class SyncCloudEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SyncCloudEndpointState, opts?: pulumi.CustomResourceOptions): SyncCloudEndpoint;
    /**
     * Returns true if the given object is an instance of SyncCloudEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SyncCloudEndpoint;
    /**
     ...
     */
    readonly storageAccountTenantId: pulumi.Output<string>;
    /**
