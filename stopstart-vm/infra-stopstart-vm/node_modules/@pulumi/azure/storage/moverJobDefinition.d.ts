 ...
 * ```
 */
export declare class MoverJobDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverJobDefinitionState, opts?: pulumi.CustomResourceOptions): MoverJobDefinition;
    /**
     * Returns true if the given object is an instance of MoverJobDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoverJobDefinition;
    /**
     ...
     */
    readonly storageMoverProjectId: pulumi.Output<string>;
    /**
