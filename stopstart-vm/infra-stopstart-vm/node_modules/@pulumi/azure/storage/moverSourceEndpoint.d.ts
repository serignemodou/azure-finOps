 ...
 * ```
 */
export declare class MoverSourceEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverSourceEndpointState, opts?: pulumi.CustomResourceOptions): MoverSourceEndpoint;
    /**
     * Returns true if the given object is an instance of MoverSourceEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoverSourceEndpoint;
    /**
     ...
     */
    readonly nfsVersion: pulumi.Output<string | undefined>;
    /**
