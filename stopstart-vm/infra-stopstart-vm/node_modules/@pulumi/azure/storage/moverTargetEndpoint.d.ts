 ...
 * ```
 */
export declare class MoverTargetEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverTargetEndpointState, opts?: pulumi.CustomResourceOptions): MoverTargetEndpoint;
    /**
     * Returns true if the given object is an instance of MoverTargetEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoverTargetEndpoint;
    /**
