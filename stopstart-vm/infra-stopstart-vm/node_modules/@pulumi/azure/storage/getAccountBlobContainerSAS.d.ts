 ...
 * ```
 */
export declare function getAccountBlobContainerSAS(args: GetAccountBlobContainerSASArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountBlobContainerSASResult>;
/**
 ...
 * ```
 */
export declare function getAccountBlobContainerSASOutput(args: GetAccountBlobContainerSASOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountBlobContainerSASResult>;
/**
 * A collection of arguments for invoking getAccountBlobContainerSAS.
 */
