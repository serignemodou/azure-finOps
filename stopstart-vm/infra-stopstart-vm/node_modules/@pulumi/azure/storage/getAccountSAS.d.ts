 ...
 * ```
 */
export declare function getAccountSAS(args: GetAccountSASArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountSASResult>;
/**
 ...
 * ```
 */
export declare function getAccountSASOutput(args: GetAccountSASOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountSASResult>;
/**
 * A collection of arguments for invoking getAccountSAS.
 */
