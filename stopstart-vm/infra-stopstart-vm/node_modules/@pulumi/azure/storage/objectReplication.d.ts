 ...
 * ```
 */
export declare class ObjectReplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectReplicationState, opts?: pulumi.CustomResourceOptions): ObjectReplication;
    /**
     * Returns true if the given object is an instance of ObjectReplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObjectReplication;
    /**
     * The ID of the Object Replication in the destination storage account.
     */
    readonly destinationObjectReplicationId: pulumi.Output<string>;
    /**
     * The ID of the destination storage account. Changing this forces a new Storage Object Replication to be created.
     */
    readonly destinationStorageAccountId: pulumi.Output<string>;
    /**
     * One or more `rules` blocks as defined below.
     */
    readonly rules: pulumi.Output<outputs.storage.ObjectReplicationRule[]>;
    /**
     * The ID of the Object Replication in the source storage account.
     */
    readonly sourceObjectReplicationId: pulumi.Output<string>;
    /**
