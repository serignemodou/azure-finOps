 ...
 * ```
 */
export declare class MoverAgent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverAgentState, opts?: pulumi.CustomResourceOptions): MoverAgent;
    /**
     * Returns true if the given object is an instance of MoverAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoverAgent;
    /**
     ...
     */
    readonly storageMoverId: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: MoverAgentArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering MoverAgent resources.
 */
export interface MoverAgentState {
    /**
     * Specifies the fully qualified ID of the Hybrid Compute resource for the Storage Mover Agent. Changing this forces a new resource to be created.
     */
