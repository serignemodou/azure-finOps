 ...
 * ```
 */
export declare class MoverProject extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverProjectState, opts?: pulumi.CustomResourceOptions): MoverProject;
    /**
     * Returns true if the given object is an instance of MoverProject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MoverProject;
    /**
