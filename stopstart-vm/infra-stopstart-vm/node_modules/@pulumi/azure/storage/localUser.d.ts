...
export declare class LocalUser extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalUserState, opts?: pulumi.CustomResourceOptions): LocalUser;
    /**
     ...
     */
    readonly permissionScopes: pulumi.Output<outputs.storage.LocalUserPermissionScope[] | undefined>;
    /**
     ...
     */
    readonly sshAuthorizedKeys: pulumi.Output<outputs.storage.LocalUserSshAuthorizedKey[] | undefined>;
    /**
     * Specifies whether SSH Key Authentication is enabled. Defaults to `false`.
     */
    readonly sshKeyEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Specifies whether SSH Password Authentication is enabled. Defaults to `false`.
     */
    readonly sshPasswordEnabled: pulumi.Output<boolean | undefined>;
    /**
