 ...
 * ```
 */
export declare class SyncServerEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SyncServerEndpointState, opts?: pulumi.CustomResourceOptions): SyncServerEndpoint;
    /**
     * Returns true if the given object is an instance of SyncServerEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SyncServerEndpoint;
    /**
     * Is Cloud Tiering Enabled? Defaults to `false`.
     */
    readonly cloudTieringEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly registeredServerId: pulumi.Output<string>;
    /**
     ...
     */
    readonly serverLocalPath: pulumi.Output<string>;
    /**
     ...
     */
    readonly storageSyncGroupId: pulumi.Output<string>;
    /**
