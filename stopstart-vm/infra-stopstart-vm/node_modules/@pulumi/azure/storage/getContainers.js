...
exports.getContainersOutput = exports.getContainers = void 0;
 ...
 * ```
 */
function getContainers(args, opts) {
 ...
 * ```
 */
function getContainersOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getContainersOutput = getContainersOutput;
//# sourceMappingURL=getContainers.js.map