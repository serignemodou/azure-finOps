...
exports.Workspace = exports.SubscriptionPricing = exports.StorageDefender = exports.Setting = exports.ServerVulnerabilityAssessmentsSetting = exports.ServerVulnerabilityAssessmentVirtualMachine = exports.Contact = exports.Automation = exports.AutoProvisioning = exports.AssessmentPolicy = exports.Assessment = exports.AdvancedThreatProtection = void 0;
...
exports.ServerVulnerabilityAssessmentVirtualMachine = null;
...
exports.ServerVulnerabilityAssessmentsSetting = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:securitycenter/assessmentPolicy:AssessmentPolicy":
                return new exports.AssessmentPolicy(name, undefined, { urn });
            case "azure:securitycenter/autoProvisioning:AutoProvisioning":
                return new exports.AutoProvisioning(name, undefined, { urn });
            ...
            case "azure:securitycenter/serverVulnerabilityAssessmentVirtualMachine:ServerVulnerabilityAssessmentVirtualMachine":
                return new exports.ServerVulnerabilityAssessmentVirtualMachine(name, undefined, { urn });
            case "azure:securitycenter/serverVulnerabilityAssessmentsSetting:ServerVulnerabilityAssessmentsSetting":
                return new exports.ServerVulnerabilityAssessmentsSetting(name, undefined, { urn });
            ...
            case "azure:securitycenter/storageDefender:StorageDefender":
                return new exports.StorageDefender(name, undefined, { urn });
            case "azure:securitycenter/subscriptionPricing:SubscriptionPricing":
                return new exports.SubscriptionPricing(name, undefined, { urn });
