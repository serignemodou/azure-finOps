 ...
 * ```
 */
export declare class StorageDefender extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StorageDefenderState, opts?: pulumi.CustomResourceOptions): StorageDefender;
    /**
     * Returns true if the given object is an instance of StorageDefender.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StorageDefender;
    /**
     ...
     */
    readonly malwareScanningOnUploadCapGbPerMonth: pulumi.Output<number | undefined>;
    /**
     * Whether On Upload malware scanning should be enabled. Defaults to `false`.
     */
    readonly malwareScanningOnUploadEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly overrideSubscriptionSettingsEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly scanResultsEventGridTopicId: pulumi.Output<string | undefined>;
    /**
     * Whether Sensitive Data Discovery should be enabled. Defaults to `false`.
     */
    readonly sensitiveDataDiscoveryEnabled: pulumi.Output<boolean | undefined>;
    /**
