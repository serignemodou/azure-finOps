 ...
 * ```
 */
export declare class AutoProvisioning extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutoProvisioningState, opts?: pulumi.CustomResourceOptions): AutoProvisioning;
    /**
     * Returns true if the given object is an instance of AutoProvisioning.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AutoProvisioning;
    /**
     ...
     */
    readonly autoProvision: pulumi.Output<string>;
    /**
