 ...
 * ```
 */
export declare class RegistryToken extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryTokenState, opts?: pulumi.CustomResourceOptions): RegistryToken;
    /**
     * Returns true if the given object is an instance of RegistryToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryToken;
    /**
     ...
     */
    readonly scopeMapId: pulumi.Output<string>;
    /**
