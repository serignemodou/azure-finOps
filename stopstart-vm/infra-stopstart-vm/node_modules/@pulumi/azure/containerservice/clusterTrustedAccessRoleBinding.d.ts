 ...
 */
export declare class ClusterTrustedAccessRoleBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterTrustedAccessRoleBindingState, opts?: pulumi.CustomResourceOptions): ClusterTrustedAccessRoleBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is ClusterTrustedAccessRoleBinding;
    /**
