 ...
 */
export declare class KubernetesFleetManager extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesFleetManagerState, opts?: pulumi.CustomResourceOptions): KubernetesFleetManager;
    /**
     * Returns true if the given object is an instance of KubernetesFleetManager.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is KubernetesFleetManager;
    /**
     ...
     */
    readonly hubProfile: pulumi.Output<outputs.containerservice.KubernetesFleetManagerHubProfile | undefined>;
    /**
