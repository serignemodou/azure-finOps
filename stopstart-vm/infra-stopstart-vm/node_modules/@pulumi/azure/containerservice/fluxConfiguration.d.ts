...
export declare class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FluxConfigurationState, opts?: pulumi.CustomResourceOptions): FluxConfiguration;
    /**
     ...
     */
    readonly blobStorage: pulumi.Output<outputs.containerservice.FluxConfigurationBlobStorage | undefined>;
    /**
     * A `bucket` block as defined below.
     */
    readonly bucket: pulumi.Output<outputs.containerservice.FluxConfigurationBucket | undefined>;
    /**
     ...
     */
    readonly continuousReconciliationEnabled: pulumi.Output<boolean | undefined>;
    /**
     * A `gitRepository` block as defined below.
     */
    readonly gitRepository: pulumi.Output<outputs.containerservice.FluxConfigurationGitRepository | undefined>;
    /**
     * A `kustomizations` block as defined below.
     */
    readonly kustomizations: pulumi.Output<outputs.containerservice.FluxConfigurationKustomization[]>;
    /**
