 ...
 * ```
 */
export declare class RegistryCacheRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryCacheRuleState, opts?: pulumi.CustomResourceOptions): RegistryCacheRule;
    /**
     * Returns true if the given object is an instance of RegistryCacheRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryCacheRule;
    /**
     ...
     */
    readonly credentialSetId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly targetRepo: pulumi.Output<string>;
    /**
