 ...
 * ```
 */
export declare class RegistryWebhook extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryWebhookState, opts?: pulumi.CustomResourceOptions): RegistryWebhook;
    /**
     * Returns true if the given object is an instance of RegistryWebhook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryWebhook;
    /**
