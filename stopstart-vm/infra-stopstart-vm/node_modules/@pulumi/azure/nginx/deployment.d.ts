...
export declare class Deployment extends pulumi.CustomResource {
     ...
     */
    readonly dataplaneApiEndpoint: pulumi.Output<string>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.nginx.DeploymentIdentity | undefined>;
    /**
     ...
     */
    readonly webApplicationFirewall: pulumi.Output<outputs.nginx.DeploymentWebApplicationFirewall | undefined>;
    /**
