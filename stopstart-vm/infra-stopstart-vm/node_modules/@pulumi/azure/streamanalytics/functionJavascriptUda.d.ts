 ...
 * ```
 */
export declare class FunctionJavascriptUda extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionJavascriptUdaState, opts?: pulumi.CustomResourceOptions): FunctionJavascriptUda;
    /**
     * Returns true if the given object is an instance of FunctionJavascriptUda.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FunctionJavascriptUda;
    /**
     * One or more `input` blocks as defined below.
     */
    readonly inputs: pulumi.Output<outputs.streamanalytics.FunctionJavascriptUdaInput[]>;
    /**
     ...
     */
    readonly output: pulumi.Output<outputs.streamanalytics.FunctionJavascriptUdaOutput>;
    /**
