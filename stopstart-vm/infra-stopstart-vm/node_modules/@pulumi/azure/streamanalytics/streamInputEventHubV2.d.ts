 ...
 * ```
 */
export declare class StreamInputEventHubV2 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamInputEventHubV2State, opts?: pulumi.CustomResourceOptions): StreamInputEventHubV2;
    /**
     * Returns true if the given object is an instance of StreamInputEventHubV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StreamInputEventHubV2;
    /**
     ...
     */
    readonly serialization: pulumi.Output<outputs.streamanalytics.StreamInputEventHubV2Serialization>;
    /**
