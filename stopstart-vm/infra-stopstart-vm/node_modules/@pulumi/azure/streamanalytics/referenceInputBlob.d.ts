 ...
 * ```
 */
export declare class ReferenceInputBlob extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReferenceInputBlobState, opts?: pulumi.CustomResourceOptions): ReferenceInputBlob;
    /**
     * Returns true if the given object is an instance of ReferenceInputBlob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ReferenceInputBlob;
    /**
     ...
     */
    readonly serialization: pulumi.Output<outputs.streamanalytics.ReferenceInputBlobSerialization>;
    /**
