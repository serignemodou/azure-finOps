 ...
 * ```
 */
export declare class ServiceCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceCustomDomainState, opts?: pulumi.CustomResourceOptions): ServiceCustomDomain;
    /**
     * Returns true if the given object is an instance of ServiceCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceCustomDomain;
    /**
     ...
     */
    readonly signalrCustomCertificateId: pulumi.Output<string>;
    /**
