...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["auxiliaryTenantIds"] = pulumi.output((args === null || args === void 0 ? void 0 : args.auxiliaryTenantIds) ? pulumi.secret(args.auxiliaryTenantIds) : undefined).apply(JSON.stringify);
