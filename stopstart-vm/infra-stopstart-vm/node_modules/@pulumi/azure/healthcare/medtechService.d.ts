 ...
 * ```
 */
export declare class MedtechService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MedtechServiceState, opts?: pulumi.CustomResourceOptions): MedtechService;
    /**
     * Returns true if the given object is an instance of MedtechService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MedtechService;
    /**
     * Specifies the Device Mappings of the Med Tech Service.
     */
    readonly deviceMappingJson: pulumi.Output<string>;
    /**
     ...
     */
    readonly eventhubNamespaceName: pulumi.Output<string>;
    /**
     * An `identity` block as defined below.
     */
    readonly identity: pulumi.Output<outputs.healthcare.MedtechServiceIdentity | undefined>;
    /**
