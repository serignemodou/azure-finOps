 ...
 * ```
 */
export declare class MedtechServiceFhirDestination extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MedtechServiceFhirDestinationState, opts?: pulumi.CustomResourceOptions): MedtechServiceFhirDestination;
    /**
     ...
     */
    static isInstance(obj: any): obj is MedtechServiceFhirDestination;
    /**
     * Specifies the destination Fhir mappings of the Med Tech Service Fhir Destination.
     */
    readonly destinationFhirMappingJson: pulumi.Output<string>;
    /**
     * Specifies the destination fhir service id of the Med Tech Service Fhir Destination.
     */
    readonly destinationFhirServiceId: pulumi.Output<string>;
    /**
     ...
     */
    readonly destinationIdentityResolutionType: pulumi.Output<string>;
    /**
     ...
     */
    readonly medtechServiceId: pulumi.Output<string>;
    /**
