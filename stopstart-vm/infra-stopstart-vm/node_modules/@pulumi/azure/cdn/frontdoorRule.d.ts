 ...
 * ```
 */
export declare class FrontdoorRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorRuleState, opts?: pulumi.CustomResourceOptions): FrontdoorRule;
    /**
     * Returns true if the given object is an instance of FrontdoorRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorRule;
    /**
     * An `actions` block as defined below.
     */
    readonly actions: pulumi.Output<outputs.cdn.FrontdoorRuleActions>;
    /**
     ...
     */
    readonly behaviorOnMatch: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly cdnFrontdoorRuleSetId: pulumi.Output<string>;
    /**
     * The name of the Front Door Rule Set containing this Front Door Rule.
     */
    readonly cdnFrontdoorRuleSetName: pulumi.Output<string>;
    /**
     * A `conditions` block as defined below.
     */
    readonly conditions: pulumi.Output<outputs.cdn.FrontdoorRuleConditions | undefined>;
    /**
