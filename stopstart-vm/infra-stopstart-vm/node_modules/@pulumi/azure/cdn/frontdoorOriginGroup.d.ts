 ...
 * ```
 */
export declare class FrontdoorOriginGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorOriginGroupState, opts?: pulumi.CustomResourceOptions): FrontdoorOriginGroup;
    /**
     * Returns true if the given object is an instance of FrontdoorOriginGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorOriginGroup;
    /**
     ...
     */
    readonly healthProbe: pulumi.Output<outputs.cdn.FrontdoorOriginGroupHealthProbe | undefined>;
    /**
     * A `loadBalancing` block as defined below.
     */
    readonly loadBalancing: pulumi.Output<outputs.cdn.FrontdoorOriginGroupLoadBalancing>;
    /**
     ...
     */
    readonly restoreTrafficTimeToHealedOrNewEndpointInMinutes: pulumi.Output<number | undefined>;
    /**
     * Specifies whether session affinity should be enabled on this host. Defaults to `true`.
     */
    readonly sessionAffinityEnabled: pulumi.Output<boolean | undefined>;
    /**
