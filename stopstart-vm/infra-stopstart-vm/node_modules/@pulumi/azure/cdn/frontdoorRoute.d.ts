 ...
 * ```
 */
export declare class FrontdoorRoute extends pulumi.CustomResource {
    /**
     ...
     */
    readonly httpsRedirectEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Should this Front Door Route be linked to the default endpoint? Possible values include `true` or `false`. Defaults to `true`.
     */
    readonly linkToDefaultDomain: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly patternsToMatches: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly supportedProtocols: pulumi.Output<string[]>;
    /**
