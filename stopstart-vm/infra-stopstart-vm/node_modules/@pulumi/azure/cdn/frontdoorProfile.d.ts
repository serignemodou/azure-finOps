 ...
 * ```
 */
export declare class FrontdoorProfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorProfileState, opts?: pulumi.CustomResourceOptions): FrontdoorProfile;
    /**
     * Returns true if the given object is an instance of FrontdoorProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorProfile;
    /**
     ...
     */
    readonly responseTimeoutSeconds: pulumi.Output<number | undefined>;
    /**
