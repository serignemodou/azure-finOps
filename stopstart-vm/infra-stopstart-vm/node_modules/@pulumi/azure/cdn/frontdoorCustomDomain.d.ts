 ...
 * ```
 */
export declare class FrontdoorCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorCustomDomainState, opts?: pulumi.CustomResourceOptions): FrontdoorCustomDomain;
    /**
     ...
     */
    readonly tls: pulumi.Output<outputs.cdn.FrontdoorCustomDomainTls>;
    /**
