 ...
 * ```
 */
export declare class FrontdoorOrigin extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorOriginState, opts?: pulumi.CustomResourceOptions): FrontdoorOrigin;
    /**
     * Returns true if the given object is an instance of FrontdoorOrigin.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorOrigin;
    /**
     ...
     */
    readonly certificateNameCheckEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly privateLink: pulumi.Output<outputs.cdn.FrontdoorOriginPrivateLink | undefined>;
    /**
