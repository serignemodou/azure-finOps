 ...
 * ```
 */
export declare class FrontdoorSecurityPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorSecurityPolicyState, opts?: pulumi.CustomResourceOptions): FrontdoorSecurityPolicy;
    /**
     * Returns true if the given object is an instance of FrontdoorSecurityPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorSecurityPolicy;
    /**
