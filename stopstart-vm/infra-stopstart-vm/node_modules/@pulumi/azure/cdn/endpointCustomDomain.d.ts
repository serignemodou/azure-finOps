 ...
 * ```
 */
export declare class EndpointCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EndpointCustomDomainState, opts?: pulumi.CustomResourceOptions): EndpointCustomDomain;
    /**
     * Returns true if the given object is an instance of EndpointCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EndpointCustomDomain;
    /**
     * The ID of the CDN Endpoint. Changing this forces a new CDN Endpoint Custom Domain to be created.
     */
    readonly cdnEndpointId: pulumi.Output<string>;
    /**
     * A `cdnManagedHttps` block as defined below.
     */
    readonly cdnManagedHttps: pulumi.Output<outputs.cdn.EndpointCustomDomainCdnManagedHttps | undefined>;
    /**
     ...
     */
    readonly userManagedHttps: pulumi.Output<outputs.cdn.EndpointCustomDomainUserManagedHttps | undefined>;
    /**
