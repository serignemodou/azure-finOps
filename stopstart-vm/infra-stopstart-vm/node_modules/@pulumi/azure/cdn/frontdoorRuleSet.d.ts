 ...
 * ```
 */
export declare class FrontdoorRuleSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorRuleSetState, opts?: pulumi.CustomResourceOptions): FrontdoorRuleSet;
    /**
     * Returns true if the given object is an instance of FrontdoorRuleSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorRuleSet;
    /**
