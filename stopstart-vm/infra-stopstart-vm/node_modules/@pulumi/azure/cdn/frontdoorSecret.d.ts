 ...
 * ```
 */
export declare class FrontdoorSecret extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FrontdoorSecretState, opts?: pulumi.CustomResourceOptions): FrontdoorSecret;
    /**
     * Returns true if the given object is an instance of FrontdoorSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FrontdoorSecret;
    /**
     ...
     */
    readonly cdnFrontdoorProfileName: pulumi.Output<string>;
    /**
     ...
     */
    readonly secret: pulumi.Output<outputs.cdn.FrontdoorSecretSecret>;
    /**
