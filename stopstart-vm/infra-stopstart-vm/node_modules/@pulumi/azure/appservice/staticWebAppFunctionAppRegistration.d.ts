 ...
 * ```
 */
export declare class StaticWebAppFunctionAppRegistration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StaticWebAppFunctionAppRegistrationState, opts?: pulumi.CustomResourceOptions): StaticWebAppFunctionAppRegistration;
    /**
     ...
     */
    static isInstance(obj: any): obj is StaticWebAppFunctionAppRegistration;
    /**
