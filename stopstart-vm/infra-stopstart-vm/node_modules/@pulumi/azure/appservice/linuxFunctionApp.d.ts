...
export declare class LinuxFunctionApp extends pulumi.CustomResource {
     ...
     */
    readonly authSettings: pulumi.Output<outputs.appservice.LinuxFunctionAppAuthSettings | undefined>;
    /**
     * An `authSettingsV2` block as defined below.
     */
    readonly authSettingsV2: pulumi.Output<outputs.appservice.LinuxFunctionAppAuthSettingsV2 | undefined>;
    /**
     ...
     */
    readonly stickySettings: pulumi.Output<outputs.appservice.LinuxFunctionAppStickySettings | undefined>;
    /**
     ...
     */
    readonly storageAccounts: pulumi.Output<outputs.appservice.LinuxFunctionAppStorageAccount[] | undefined>;
    /**
...
export interface LinuxFunctionAppState {
     ...
     * One or more `storageAccount` blocks as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppStorageAccount>[]>;
    /**
     * The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App.
     *
     * > **Note:** `storageKeyVaultSecretId` cannot be used with `storageAccountName`.
