...
class WebAppHybridConnection extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new WebAppHybridConnection(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["webAppId"] = state ? state.webAppId : undefined;
        }
        else {
            ...
            resourceInputs["webAppId"] = args ? args.webAppId : undefined;
...
/** @internal */
WebAppHybridConnection.__pulumiType = 'azure:appservice/webAppHybridConnection:WebAppHybridConnection';
