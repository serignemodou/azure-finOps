 ...
 * ```
 */
export declare function getFunctionApp(args: GetFunctionAppArgs, opts?: pulumi.InvokeOptions): Promise<GetFunctionAppResult>;
/**
 ...
 * ```
 */
export declare function getFunctionAppOutput(args: GetFunctionAppOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFunctionAppResult>;
/**
 * A collection of arguments for invoking getFunctionApp.
 */
