...
export declare const ActiveSlot: typeof import("./activeSlot").ActiveSlot;
...
export declare const AppFlexConsumption: typeof import("./appFlexConsumption").AppFlexConsumption;
export { AppServiceArgs, AppServiceState } from "./appService";
export type AppService = import("./appService").AppService;
export declare const AppService: typeof import("./appService").AppService;
...
export declare const CertificateBinding: typeof import("./certificateBinding").CertificateBinding;
...
export declare const CertificateOrder: typeof import("./certificateOrder").CertificateOrder;
...
export declare const CustomHostnameBinding: typeof import("./customHostnameBinding").CustomHostnameBinding;
...
export declare const EnvironmentV3: typeof import("./environmentV3").EnvironmentV3;
export { FunctionAppArgs, FunctionAppState } from "./functionApp";
export type FunctionApp = import("./functionApp").FunctionApp;
export declare const FunctionApp: typeof import("./functionApp").FunctionApp;
...
export declare const FunctionAppActiveSlot: typeof import("./functionAppActiveSlot").FunctionAppActiveSlot;
...
export declare const FunctionAppFunction: typeof import("./functionAppFunction").FunctionAppFunction;
...
export declare const FunctionAppHybridConnection: typeof import("./functionAppHybridConnection").FunctionAppHybridConnection;
...
export declare const FunctionAppSlot: typeof import("./functionAppSlot").FunctionAppSlot;
export { GetAppServiceArgs, GetAppServiceResult, GetAppServiceOutputArgs } from "./getAppService";
export declare const getAppService: typeof import("./getAppService").getAppService;
export declare const getAppServiceOutput: typeof import("./getAppService").getAppServiceOutput;
...
export declare const getCertificateOrder: typeof import("./getCertificateOrder").getCertificateOrder;
export declare const getCertificateOrderOutput: typeof import("./getCertificateOrder").getCertificateOrderOutput;
export { GetEnvironmentV3Args, GetEnvironmentV3Result, GetEnvironmentV3OutputArgs } from "./getEnvironmentV3";
export declare const getEnvironmentV3: typeof import("./getEnvironmentV3").getEnvironmentV3;
export declare const getEnvironmentV3Output: typeof import("./getEnvironmentV3").getEnvironmentV3Output;
export { GetFunctionAppArgs, GetFunctionAppResult, GetFunctionAppOutputArgs } from "./getFunctionApp";
export declare const getFunctionApp: typeof import("./getFunctionApp").getFunctionApp;
export declare const getFunctionAppOutput: typeof import("./getFunctionApp").getFunctionAppOutput;
...
export declare const getFunctionAppHostKeys: typeof import("./getFunctionAppHostKeys").getFunctionAppHostKeys;
export declare const getFunctionAppHostKeysOutput: typeof import("./getFunctionAppHostKeys").getFunctionAppHostKeysOutput;
export { GetLinuxFunctionAppArgs, GetLinuxFunctionAppResult, GetLinuxFunctionAppOutputArgs } from "./getLinuxFunctionApp";
export declare const getLinuxFunctionApp: typeof import("./getLinuxFunctionApp").getLinuxFunctionApp;
...
export declare const getLinuxWebApp: typeof import("./getLinuxWebApp").getLinuxWebApp;
export declare const getLinuxWebAppOutput: typeof import("./getLinuxWebApp").getLinuxWebAppOutput;
...
export declare const getSourceControlToken: typeof import("./getSourceControlToken").getSourceControlToken;
export declare const getSourceControlTokenOutput: typeof import("./getSourceControlToken").getSourceControlTokenOutput;
export { GetStaticWebAppArgs, GetStaticWebAppResult, GetStaticWebAppOutputArgs } from "./getStaticWebApp";
export declare const getStaticWebApp: typeof import("./getStaticWebApp").getStaticWebApp;
export declare const getStaticWebAppOutput: typeof import("./getStaticWebApp").getStaticWebAppOutput;
export { GetWindowsFunctionAppArgs, GetWindowsFunctionAppResult, GetWindowsFunctionAppOutputArgs } from "./getWindowsFunctionApp";
export declare const getWindowsFunctionApp: typeof import("./getWindowsFunctionApp").getWindowsFunctionApp;
export declare const getWindowsFunctionAppOutput: typeof import("./getWindowsFunctionApp").getWindowsFunctionAppOutput;
export { GetWindowsWebAppArgs, GetWindowsWebAppResult, GetWindowsWebAppOutputArgs } from "./getWindowsWebApp";
export declare const getWindowsWebApp: typeof import("./getWindowsWebApp").getWindowsWebApp;
export declare const getWindowsWebAppOutput: typeof import("./getWindowsWebApp").getWindowsWebAppOutput;
...
export declare const LinuxFunctionApp: typeof import("./linuxFunctionApp").LinuxFunctionApp;
...
export declare const LinuxFunctionAppSlot: typeof import("./linuxFunctionAppSlot").LinuxFunctionAppSlot;
export { LinuxWebAppArgs, LinuxWebAppState } from "./linuxWebApp";
export type LinuxWebApp = import("./linuxWebApp").LinuxWebApp;
export declare const LinuxWebApp: typeof import("./linuxWebApp").LinuxWebApp;
...
export declare const LinuxWebAppSlot: typeof import("./linuxWebAppSlot").LinuxWebAppSlot;
...
export declare const PublicCertificate: typeof import("./publicCertificate").PublicCertificate;
export { ServicePlanArgs, ServicePlanState } from "./servicePlan";
export type ServicePlan = import("./servicePlan").ServicePlan;
export declare const ServicePlan: typeof import("./servicePlan").ServicePlan;
export { SlotArgs, SlotState } from "./slot";
export type Slot = import("./slot").Slot;
export declare const Slot: typeof import("./slot").Slot;
...
export declare const SlotCustomHostnameBinding: typeof import("./slotCustomHostnameBinding").SlotCustomHostnameBinding;
...
export declare const SourceControlSlot: typeof import("./sourceControlSlot").SourceControlSlot;
...
export declare const SourceControlToken: typeof import("./sourceControlToken").SourceControlToken;
...
export declare const StaticWebApp: typeof import("./staticWebApp").StaticWebApp;
...
export declare const StaticWebAppCustomDomain: typeof import("./staticWebAppCustomDomain").StaticWebAppCustomDomain;
...
export declare const StaticWebAppFunctionAppRegistration: typeof import("./staticWebAppFunctionAppRegistration").StaticWebAppFunctionAppRegistration;
...
export declare const VirtualNetworkSwiftConnection: typeof import("./virtualNetworkSwiftConnection").VirtualNetworkSwiftConnection;
...
export declare const WebAppActiveSlot: typeof import("./webAppActiveSlot").WebAppActiveSlot;
...
export declare const WindowsWebApp: typeof import("./windowsWebApp").WindowsWebApp;
...
export declare const WindowsWebAppSlot: typeof import("./windowsWebAppSlot").WindowsWebAppSlot;
export * from "./zMixins";
