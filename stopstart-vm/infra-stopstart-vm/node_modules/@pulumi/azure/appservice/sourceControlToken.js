...
exports.SourceControlToken = void 0;
...
class SourceControlToken extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new SourceControlToken(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["tokenSecret"] = (args === null || args === void 0 ? void 0 : args.tokenSecret) ? pulumi.secret(args.tokenSecret) : undefined;
...
exports.SourceControlToken = SourceControlToken;
/** @internal */
SourceControlToken.__pulumiType = 'azure:appservice/sourceControlToken:SourceControlToken';
//# sourceMappingURL=sourceControlToken.js.map