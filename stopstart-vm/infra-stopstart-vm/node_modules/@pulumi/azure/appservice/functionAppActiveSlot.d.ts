 ...
 * ```
 */
export declare class FunctionAppActiveSlot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionAppActiveSlotState, opts?: pulumi.CustomResourceOptions): FunctionAppActiveSlot;
    /**
     * Returns true if the given object is an instance of FunctionAppActiveSlot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FunctionAppActiveSlot;
    /**
     * The timestamp of the last successful swap with `Production`
     */
    readonly lastSuccessfulSwap: pulumi.Output<string>;
    /**
     * The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to `true`. Changing this forces a new resource to be created.
     */
    readonly overwriteNetworkConfig: pulumi.Output<boolean | undefined>;
    /**
