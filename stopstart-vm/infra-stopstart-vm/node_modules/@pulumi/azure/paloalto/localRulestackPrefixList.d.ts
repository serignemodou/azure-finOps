 ...
 * ```
 */
export declare class LocalRulestackPrefixList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalRulestackPrefixListState, opts?: pulumi.CustomResourceOptions): LocalRulestackPrefixList;
    /**
     * Returns true if the given object is an instance of LocalRulestackPrefixList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocalRulestackPrefixList;
    /**
