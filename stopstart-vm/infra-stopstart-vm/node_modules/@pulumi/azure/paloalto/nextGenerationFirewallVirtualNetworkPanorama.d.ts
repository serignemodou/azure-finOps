 ...
 * ```
 */
export declare class NextGenerationFirewallVirtualNetworkPanorama extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NextGenerationFirewallVirtualNetworkPanoramaState, opts?: pulumi.CustomResourceOptions): NextGenerationFirewallVirtualNetworkPanorama;
    /**
     ...
     */
    static isInstance(obj: any): obj is NextGenerationFirewallVirtualNetworkPanorama;
    /**
     * One or more `destinationNat` blocks as defined below.
     */
    readonly destinationNats: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkPanoramaDestinationNat[] | undefined>;
    /**
     * A `dnsSettings` block as defined below.
     */
    readonly dnsSettings: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkPanoramaDnsSettings | undefined>;
    /**
     ...
     */
    readonly networkProfile: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile>;
    /**
     * The base64 encoded configuration registration string as defined by your Panorama Server for your Cloud Device Group.
     */
    readonly panoramaBase64Config: pulumi.Output<string>;
    /**
     * A `panorama` block as defined below.
     */
    readonly panoramas: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkPanoramaPanorama[]>;
    /**
