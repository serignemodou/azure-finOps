...
export declare class LocalRulestack extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalRulestackState, opts?: pulumi.CustomResourceOptions): LocalRulestack;
    /**
     ...
     */
    readonly antiSpywareProfile: pulumi.Output<string | undefined>;
    /**
     * The setting to use for Anti-Virus. Possible values include `BestPractice`, and `Custom`.
     */
    readonly antiVirusProfile: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly dnsSubscription: pulumi.Output<string | undefined>;
    /**
     * The setting to use for the File Blocking Profile. Possible values include `BestPractice`, and `Custom`.
     */
    readonly fileBlockingProfile: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly vulnerabilityProfile: pulumi.Output<string | undefined>;
    /**
