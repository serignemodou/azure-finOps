 ...
 * ```
 */
export declare class LocalRulestackFqdnList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalRulestackFqdnListState, opts?: pulumi.CustomResourceOptions): LocalRulestackFqdnList;
    /**
     * Returns true if the given object is an instance of LocalRulestackFqdnList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocalRulestackFqdnList;
    /**
     ...
     */
    readonly fullyQualifiedDomainNames: pulumi.Output<string[]>;
    /**
