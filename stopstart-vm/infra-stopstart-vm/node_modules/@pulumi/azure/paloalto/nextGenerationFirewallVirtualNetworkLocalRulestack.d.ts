 ...
 * ```
 */
export declare class NextGenerationFirewallVirtualNetworkLocalRulestack extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NextGenerationFirewallVirtualNetworkLocalRulestackState, opts?: pulumi.CustomResourceOptions): NextGenerationFirewallVirtualNetworkLocalRulestack;
    /**
     ...
     */
    static isInstance(obj: any): obj is NextGenerationFirewallVirtualNetworkLocalRulestack;
    /**
     * One or more `destinationNat` blocks as defined below.
     */
    readonly destinationNats: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat[] | undefined>;
    /**
     * A `dnsSettings` block as defined below.
     */
    readonly dnsSettings: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings | undefined>;
    /**
     ...
     */
    readonly networkProfile: pulumi.Output<outputs.paloalto.NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile>;
    /**
