...
export declare class DevCenter extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DevCenterState, opts?: pulumi.CustomResourceOptions): DevCenter;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.devcenter.DevCenterIdentity | undefined>;
    /**
