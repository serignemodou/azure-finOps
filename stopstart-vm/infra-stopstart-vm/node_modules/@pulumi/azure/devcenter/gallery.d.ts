...
export declare class Gallery extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GalleryState, opts?: pulumi.CustomResourceOptions): Gallery;
    /**
     ...
     */
    readonly sharedGalleryId: pulumi.Output<string>;
    /**
