 ...
 * ```
 */
export declare class AttachedNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AttachedNetworkState, opts?: pulumi.CustomResourceOptions): AttachedNetwork;
    /**
     * Returns true if the given object is an instance of AttachedNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AttachedNetwork;
    /**
