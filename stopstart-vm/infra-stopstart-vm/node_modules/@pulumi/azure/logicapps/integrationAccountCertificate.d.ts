...
export declare class IntegrationAccountCertificate extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IntegrationAccountCertificateState, opts?: pulumi.CustomResourceOptions): IntegrationAccountCertificate;
    /**
     ...
     */
    readonly keyVaultKey: pulumi.Output<outputs.logicapps.IntegrationAccountCertificateKeyVaultKey | undefined>;
    /**
