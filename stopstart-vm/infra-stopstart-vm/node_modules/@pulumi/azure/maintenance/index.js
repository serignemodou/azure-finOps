...
exports.getPublicConfigurationsOutput = exports.getPublicConfigurations = exports.getConfigurationOutput = exports.getConfiguration = exports.Configuration = exports.AssignmentVirtualMachineScaleSet = exports.AssignmentVirtualMachine = exports.AssignmentDynamicScope = exports.AssignmentDedicatedHost = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.AssignmentDedicatedHost = null;
utilities.lazyLoad(exports, ["AssignmentDedicatedHost"], () => require("./assignmentDedicatedHost"));
exports.AssignmentDynamicScope = null;
utilities.lazyLoad(exports, ["AssignmentDynamicScope"], () => require("./assignmentDynamicScope"));
exports.AssignmentVirtualMachine = null;
utilities.lazyLoad(exports, ["AssignmentVirtualMachine"], () => require("./assignmentVirtualMachine"));
exports.AssignmentVirtualMachineScaleSet = null;
...
exports.getPublicConfigurations = null;
exports.getPublicConfigurationsOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:maintenance/assignmentDedicatedHost:AssignmentDedicatedHost":
                return new exports.AssignmentDedicatedHost(name, undefined, { urn });
            case "azure:maintenance/assignmentDynamicScope:AssignmentDynamicScope":
                return new exports.AssignmentDynamicScope(name, undefined, { urn });
            case "azure:maintenance/assignmentVirtualMachine:AssignmentVirtualMachine":
                return new exports.AssignmentVirtualMachine(name, undefined, { urn });
            case "azure:maintenance/assignmentVirtualMachineScaleSet:AssignmentVirtualMachineScaleSet":
                return new exports.AssignmentVirtualMachineScaleSet(name, undefined, { urn });
