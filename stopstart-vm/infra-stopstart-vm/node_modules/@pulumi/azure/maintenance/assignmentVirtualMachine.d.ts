 ...
 * ```
 */
export declare class AssignmentVirtualMachine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssignmentVirtualMachineState, opts?: pulumi.CustomResourceOptions): AssignmentVirtualMachine;
    /**
     * Returns true if the given object is an instance of AssignmentVirtualMachine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AssignmentVirtualMachine;
    /**
