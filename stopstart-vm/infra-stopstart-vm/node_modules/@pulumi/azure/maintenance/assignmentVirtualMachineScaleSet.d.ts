 ...
 * ```
 */
export declare class AssignmentVirtualMachineScaleSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssignmentVirtualMachineScaleSetState, opts?: pulumi.CustomResourceOptions): AssignmentVirtualMachineScaleSet;
    /**
     ...
     */
    static isInstance(obj: any): obj is AssignmentVirtualMachineScaleSet;
    /**
