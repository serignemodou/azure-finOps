...
export declare class Configuration extends pulumi.CustomResource {
     ...
     */
    readonly inGuestUserPatchMode: pulumi.Output<string | undefined>;
    /**
     * An `installPatches` block as defined below.
     *
     * > **Note:** `installPatches` must be specified when `scope` is `InGuestPatch`.
     */
    readonly installPatches: pulumi.Output<outputs.maintenance.ConfigurationInstallPatches | undefined>;
    /**
