...
class ChannelSlack extends pulumi.CustomResource {
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["signingSecret"] = (args === null || args === void 0 ? void 0 : args.signingSecret) ? pulumi.secret(args.signingSecret) : undefined;
            resourceInputs["verificationToken"] = (args === null || args === void 0 ? void 0 : args.verificationToken) ? pulumi.secret(args.verificationToken) : undefined;
        }
