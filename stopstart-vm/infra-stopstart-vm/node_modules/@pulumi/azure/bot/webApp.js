...
class WebApp extends pulumi.CustomResource {
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["developerAppInsightsApiKey"] = (args === null || args === void 0 ? void 0 : args.developerAppInsightsApiKey) ? pulumi.secret(args.developerAppInsightsApiKey) : undefined;
            ...
            resourceInputs["luisKey"] = (args === null || args === void 0 ? void 0 : args.luisKey) ? pulumi.secret(args.luisKey) : undefined;
