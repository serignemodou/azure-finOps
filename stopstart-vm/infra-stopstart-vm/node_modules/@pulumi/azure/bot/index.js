    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:bot/channelAlexa:ChannelAlexa":
                return new exports.ChannelAlexa(name, undefined, { urn });
            case "azure:bot/channelDirectLine:ChannelDirectLine":
                return new exports.ChannelDirectLine(name, undefined, { urn });
            case "azure:bot/channelDirectLineSpeech:ChannelDirectLineSpeech":
                return new exports.ChannelDirectLineSpeech(name, undefined, { urn });
            case "azure:bot/channelEmail:ChannelEmail":
                return new exports.ChannelEmail(name, undefined, { urn });
            case "azure:bot/channelFacebook:ChannelFacebook":
                return new exports.ChannelFacebook(name, undefined, { urn });
            case "azure:bot/channelLine:ChannelLine":
                return new exports.ChannelLine(name, undefined, { urn });
            case "azure:bot/channelSlack:ChannelSlack":
                return new exports.ChannelSlack(name, undefined, { urn });
            case "azure:bot/channelSms:ChannelSms":
                return new exports.ChannelSms(name, undefined, { urn });
            case "azure:bot/channelTeams:ChannelTeams":
                return new exports.ChannelTeams(name, undefined, { urn });
            case "azure:bot/channelWebChat:ChannelWebChat":
                return new exports.ChannelWebChat(name, undefined, { urn });
            case "azure:bot/channelsRegistration:ChannelsRegistration":
                return new exports.ChannelsRegistration(name, undefined, { urn });
            case "azure:bot/connection:Connection":
                return new exports.Connection(name, undefined, { urn });
            case "azure:bot/healthbot:Healthbot":
                return new exports.Healthbot(name, undefined, { urn });
            case "azure:bot/serviceAzureBot:ServiceAzureBot":
                return new exports.ServiceAzureBot(name, undefined, { urn });
