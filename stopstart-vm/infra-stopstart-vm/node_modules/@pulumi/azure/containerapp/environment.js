...
class Environment extends pulumi.CustomResource {
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["daprApplicationInsightsConnectionString"] = (args === null || args === void 0 ? void 0 : args.daprApplicationInsightsConnectionString) ? pulumi.secret(args.daprApplicationInsightsConnectionString) : undefined;
...
/** @internal */
Environment.__pulumiType = 'azure:containerapp/environment:Environment';
