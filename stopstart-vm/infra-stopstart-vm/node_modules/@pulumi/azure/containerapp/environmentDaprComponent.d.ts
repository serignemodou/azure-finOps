 ...
 * ```
 */
export declare class EnvironmentDaprComponent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvironmentDaprComponentState, opts?: pulumi.CustomResourceOptions): EnvironmentDaprComponent;
    /**
     * Returns true if the given object is an instance of EnvironmentDaprComponent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvironmentDaprComponent;
    /**
     * The Dapr Component Type. For example `state.azure.blobstorage`. Changing this forces a new resource to be created.
     */
    readonly componentType: pulumi.Output<string>;
    /**
     ...
     */
    readonly metadatas: pulumi.Output<outputs.containerapp.EnvironmentDaprComponentMetadata[] | undefined>;
    /**
     ...
     */
    readonly secrets: pulumi.Output<outputs.containerapp.EnvironmentDaprComponentSecret[] | undefined>;
    /**
