 ...
 * ```
 */
export declare class EnvironmentCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvironmentCustomDomainState, opts?: pulumi.CustomResourceOptions): EnvironmentCustomDomain;
    /**
     * Returns true if the given object is an instance of EnvironmentCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvironmentCustomDomain;
    /**
