 ...
 * ```
 */
export declare class SpringCloudCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudCustomDomainState, opts?: pulumi.CustomResourceOptions): SpringCloudCustomDomain;
    /**
     * Returns true if the given object is an instance of SpringCloudCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SpringCloudCustomDomain;
    /**
