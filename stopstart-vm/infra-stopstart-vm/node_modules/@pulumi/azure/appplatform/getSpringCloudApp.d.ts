 ...
 * ```
 */
export declare function getSpringCloudAppOutput(args: GetSpringCloudAppOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSpringCloudAppResult>;
/**
 * A collection of arguments for invoking getSpringCloudApp.
 */
