 ...
 * ```
 */
export declare class SpringCloudConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudConnectionState, opts?: pulumi.CustomResourceOptions): SpringCloudConnection;
    /**
     * Returns true if the given object is an instance of SpringCloudConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SpringCloudConnection;
    /**
    ...
    readonly secretStore: pulumi.Output<outputs.appplatform.SpringCloudConnectionSecretStore | undefined>;
    /**
     * The ID of the data source spring cloud. Changing this forces a new resource to be created.
     */
    readonly springCloudId: pulumi.Output<string>;
    /**
