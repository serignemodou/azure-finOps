 ...
 * ```
 */
export declare class SpringCloudAppDynamicsApplicationPerformanceMonitoring extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudAppDynamicsApplicationPerformanceMonitoringState, opts?: pulumi.CustomResourceOptions): SpringCloudAppDynamicsApplicationPerformanceMonitoring;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudAppDynamicsApplicationPerformanceMonitoring;
    /**
     * Specifies the account access key used to authenticate with the Controller.
     */
    readonly agentAccountAccessKey: pulumi.Output<string>;
    /**
     * Specifies the account name of the App Dynamics account.
     */
    readonly agentAccountName: pulumi.Output<string>;
    /**
     * Specifies the name of the logical business application that this JVM node belongs to.
     */
    readonly agentApplicationName: pulumi.Output<string | undefined>;
    /**
     * Specifies the name of the node. Where JVMs are dynamically created.
     */
    readonly agentNodeName: pulumi.Output<string | undefined>;
    /**
     * Specifies the name of the tier that this JVM node belongs to.
     */
    readonly agentTierName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly agentUniqueHostId: pulumi.Output<string | undefined>;
    /**
     * Specifies the hostname or the IP address of the AppDynamics Controller.
     */
    readonly controllerHostName: pulumi.Output<string>;
    /**
     ...
     */
    readonly controllerPort: pulumi.Output<number | undefined>;
    /**
     * Specifies whether enable use SSL (HTTPS) to connect to the AppDynamics Controller.
     */
    readonly controllerSslEnabled: pulumi.Output<boolean | undefined>;
    /**
