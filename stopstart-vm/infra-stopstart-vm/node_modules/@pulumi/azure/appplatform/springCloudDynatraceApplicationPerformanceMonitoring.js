...
exports.SpringCloudDynatraceApplicationPerformanceMonitoring = void 0;
...
class SpringCloudDynatraceApplicationPerformanceMonitoring extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new SpringCloudDynatraceApplicationPerformanceMonitoring(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["tenant"] = (args === null || args === void 0 ? void 0 : args.tenant) ? pulumi.secret(args.tenant) : undefined;
            resourceInputs["tenantToken"] = (args === null || args === void 0 ? void 0 : args.tenantToken) ? pulumi.secret(args.tenantToken) : undefined;
        }
...
exports.SpringCloudDynatraceApplicationPerformanceMonitoring = SpringCloudDynatraceApplicationPerformanceMonitoring;
/** @internal */
SpringCloudDynatraceApplicationPerformanceMonitoring.__pulumiType = 'azure:appplatform/springCloudDynatraceApplicationPerformanceMonitoring:SpringCloudDynatraceApplicationPerformanceMonitoring';
//# sourceMappingURL=springCloudDynatraceApplicationPerformanceMonitoring.js.map