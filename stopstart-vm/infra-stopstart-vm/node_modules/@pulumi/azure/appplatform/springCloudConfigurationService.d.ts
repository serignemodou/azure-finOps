 ...
 * ```
 */
export declare class SpringCloudConfigurationService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudConfigurationServiceState, opts?: pulumi.CustomResourceOptions): SpringCloudConfigurationService;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudConfigurationService;
    /**
     ...
     */
    readonly refreshIntervalInSeconds: pulumi.Output<number | undefined>;
    /**
     * One or more `repository` blocks as defined below.
     */
    readonly repositories: pulumi.Output<outputs.appplatform.SpringCloudConfigurationServiceRepository[] | undefined>;
    /**
