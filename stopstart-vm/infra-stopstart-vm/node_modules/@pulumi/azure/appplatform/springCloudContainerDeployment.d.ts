 ...
 * ```
 */
export declare class SpringCloudContainerDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudContainerDeploymentState, opts?: pulumi.CustomResourceOptions): SpringCloudContainerDeployment;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudContainerDeployment;
    /**
     ...
     */
    readonly quota: pulumi.Output<outputs.appplatform.SpringCloudContainerDeploymentQuota>;
    /**
