 ...
 * ```
 */
export declare function getSpringCloudServiceOutput(args: GetSpringCloudServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSpringCloudServiceResult>;
/**
 * A collection of arguments for invoking getSpringCloudService.
 */
