 ...
 * ```
 */
export declare class SpringCloudElasticApplicationPerformanceMonitoring extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudElasticApplicationPerformanceMonitoringState, opts?: pulumi.CustomResourceOptions): SpringCloudElasticApplicationPerformanceMonitoring;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudElasticApplicationPerformanceMonitoring;
    /**
     ...
     */
    readonly applicationPackages: pulumi.Output<string[]>;
    /**
