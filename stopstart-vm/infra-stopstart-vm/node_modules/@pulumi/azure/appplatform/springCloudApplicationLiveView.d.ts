 ...
 * ```
 */
export declare class SpringCloudApplicationLiveView extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudApplicationLiveViewState, opts?: pulumi.CustomResourceOptions): SpringCloudApplicationLiveView;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudApplicationLiveView;
    /**
