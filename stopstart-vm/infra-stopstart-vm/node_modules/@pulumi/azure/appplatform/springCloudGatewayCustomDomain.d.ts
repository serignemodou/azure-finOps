 ...
 * ```
 */
export declare class SpringCloudGatewayCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudGatewayCustomDomainState, opts?: pulumi.CustomResourceOptions): SpringCloudGatewayCustomDomain;
    /**
     ...
     */
    static isInstance(obj: any): obj is SpringCloudGatewayCustomDomain;
    /**
