 ...
 * ```
 */
export declare class SpringCloudAccelerator extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpringCloudAcceleratorState, opts?: pulumi.CustomResourceOptions): SpringCloudAccelerator;
    /**
     * Returns true if the given object is an instance of SpringCloudAccelerator.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SpringCloudAccelerator;
    /**
