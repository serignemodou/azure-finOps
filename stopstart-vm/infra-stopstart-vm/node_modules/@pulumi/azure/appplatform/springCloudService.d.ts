...
export declare class SpringCloudService extends pulumi.CustomResource {
     ...
     */
    readonly buildAgentPoolSize: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly containerRegistries: pulumi.Output<outputs.appplatform.SpringCloudServiceContainerRegistry[] | undefined>;
    /**
     * A `defaultBuildService` block as defined below. This field is applicable only for Spring Cloud Service with enterprise tier.
     */
    readonly defaultBuildService: pulumi.Output<outputs.appplatform.SpringCloudServiceDefaultBuildService | undefined>;
    /**
     ...
     */
    readonly marketplace: pulumi.Output<outputs.appplatform.SpringCloudServiceMarketplace>;
    /**
     ...
     */
    readonly serviceRegistryEnabled: pulumi.Output<boolean | undefined>;
    /**
     * The ID of the Spring Cloud Service Registry.
     */
    readonly serviceRegistryId: pulumi.Output<string>;
    /**
