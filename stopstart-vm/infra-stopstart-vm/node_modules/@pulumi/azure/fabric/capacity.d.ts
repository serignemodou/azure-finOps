 ...
 * ```
 */
export declare class Capacity extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CapacityState, opts?: pulumi.CustomResourceOptions): Capacity;
    /**
     * Returns true if the given object is an instance of Capacity.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Capacity;
    /**
     ...
     */
    readonly administrationMembers: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.fabric.CapacitySku>;
    /**
