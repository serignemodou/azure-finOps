 ...
 * ```
 */
export declare class ServerTransparentDataEncryption extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServerTransparentDataEncryptionState, opts?: pulumi.CustomResourceOptions): ServerTransparentDataEncryption;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServerTransparentDataEncryption;
    /**
