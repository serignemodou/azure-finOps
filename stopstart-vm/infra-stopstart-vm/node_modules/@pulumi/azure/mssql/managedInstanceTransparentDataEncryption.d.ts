 ...
 * ```
 */
export declare class ManagedInstanceTransparentDataEncryption extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceTransparentDataEncryptionState, opts?: pulumi.CustomResourceOptions): ManagedInstanceTransparentDataEncryption;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceTransparentDataEncryption;
    /**
