...
export declare class JobStep extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JobStepState, opts?: pulumi.CustomResourceOptions): JobStep;
    /**
     ...
     */
    readonly initialRetryIntervalSeconds: pulumi.Output<number | undefined>;
    /**
     * The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
     */
    readonly jobCredentialId: pulumi.Output<string>;
    /**
     ...
     */
    readonly jobStepIndex: pulumi.Output<number>;
    /**
     * The ID of the Elastic Job Target Group.
     */
    readonly jobTargetGroupId: pulumi.Output<string>;
    /**
     ...
     */
    readonly maximumRetryIntervalSeconds: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly outputTarget: pulumi.Output<outputs.mssql.JobStepOutputTarget | undefined>;
    /**
     ...
     */
    readonly sqlScript: pulumi.Output<string>;
    /**
