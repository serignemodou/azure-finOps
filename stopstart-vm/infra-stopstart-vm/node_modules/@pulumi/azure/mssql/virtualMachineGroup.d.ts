 ...
 * ```
 */
export declare class VirtualMachineGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineGroupState, opts?: pulumi.CustomResourceOptions): VirtualMachineGroup;
    /**
     * Returns true if the given object is an instance of VirtualMachineGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VirtualMachineGroup;
    /**
     ...
     */
    readonly sqlImageOffer: pulumi.Output<string>;
    /**
     ...
     */
    readonly sqlImageSku: pulumi.Output<string>;
    /**
     ...
     */
    readonly wsfcDomainProfile: pulumi.Output<outputs.mssql.VirtualMachineGroupWsfcDomainProfile>;
    /**
