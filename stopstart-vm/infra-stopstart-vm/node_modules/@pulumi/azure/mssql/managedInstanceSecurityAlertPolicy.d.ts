 ...
 * ```
 */
export declare class ManagedInstanceSecurityAlertPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceSecurityAlertPolicyState, opts?: pulumi.CustomResourceOptions): ManagedInstanceSecurityAlertPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceSecurityAlertPolicy;
    /**
