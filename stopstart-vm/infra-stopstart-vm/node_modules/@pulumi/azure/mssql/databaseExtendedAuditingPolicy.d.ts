 ...
 * ```
 */
export declare class DatabaseExtendedAuditingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatabaseExtendedAuditingPolicyState, opts?: pulumi.CustomResourceOptions): DatabaseExtendedAuditingPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is DatabaseExtendedAuditingPolicy;
    /**
