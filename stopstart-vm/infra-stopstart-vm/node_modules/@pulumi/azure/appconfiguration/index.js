...
exports.LicationLoadBalancerSubnetAssociation = exports.LicationLoadBalancerFrontend = exports.LicationLoadBalancer = exports.getConfigurationStoreOutput = exports.getConfigurationStore = exports.getConfigurationKeysOutput = exports.getConfigurationKeys = exports.getConfigurationKeyOutput = exports.getConfigurationKey = exports.ConfigurationStore = exports.ConfigurationKey = exports.ConfigurationFeature = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.ConfigurationFeature = null;
utilities.lazyLoad(exports, ["ConfigurationFeature"], () => require("./configurationFeature"));
exports.ConfigurationKey = null;
...
exports.getConfigurationKey = null;
exports.getConfigurationKeyOutput = null;
utilities.lazyLoad(exports, ["getConfigurationKey", "getConfigurationKeyOutput"], () => require("./getConfigurationKey"));
exports.getConfigurationKeys = null;
exports.getConfigurationKeysOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:appconfiguration/configurationFeature:ConfigurationFeature":
                return new exports.ConfigurationFeature(name, undefined, { urn });
            case "azure:appconfiguration/configurationKey:ConfigurationKey":
                return new exports.ConfigurationKey(name, undefined, { urn });
            ...
            case "azure:appconfiguration/licationLoadBalancer:LicationLoadBalancer":
                return new exports.LicationLoadBalancer(name, undefined, { urn });
            case "azure:appconfiguration/licationLoadBalancerFrontend:LicationLoadBalancerFrontend":
                return new exports.LicationLoadBalancerFrontend(name, undefined, { urn });
            case "azure:appconfiguration/licationLoadBalancerSubnetAssociation:LicationLoadBalancerSubnetAssociation":
                return new exports.LicationLoadBalancerSubnetAssociation(name, undefined, { urn });
            default:
