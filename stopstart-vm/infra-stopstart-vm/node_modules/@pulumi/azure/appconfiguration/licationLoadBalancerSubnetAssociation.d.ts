 ...
 * ```
 */
export declare class LicationLoadBalancerSubnetAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LicationLoadBalancerSubnetAssociationState, opts?: pulumi.CustomResourceOptions): LicationLoadBalancerSubnetAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is LicationLoadBalancerSubnetAssociation;
    /**
     * The ID of the Application Gateway for Containers. Changing this forces a new resource to be created.
     */
    readonly applicationLoadBalancerId: pulumi.Output<string>;
    /**
