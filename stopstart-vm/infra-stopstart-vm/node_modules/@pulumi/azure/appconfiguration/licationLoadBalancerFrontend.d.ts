 ...
 * ```
 */
export declare class LicationLoadBalancerFrontend extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LicationLoadBalancerFrontendState, opts?: pulumi.CustomResourceOptions): LicationLoadBalancerFrontend;
    /**
     ...
     */
    static isInstance(obj: any): obj is LicationLoadBalancerFrontend;
    /**
