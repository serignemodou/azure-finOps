 ...
 * ```
 */
export declare class LicationLoadBalancer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LicationLoadBalancerState, opts?: pulumi.CustomResourceOptions): LicationLoadBalancer;
    /**
     * Returns true if the given object is an instance of LicationLoadBalancer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LicationLoadBalancer;
    /**
     ...
     */
    readonly primaryConfigurationEndpoint: pulumi.Output<string>;
    /**
