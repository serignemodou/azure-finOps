...
export declare const EventGridTopic: typeof import("./eventGridTopic").EventGridTopic;
...
export declare const EventHubConsumerGroup: typeof import("./eventHubConsumerGroup").EventHubConsumerGroup;
...
export declare const EventHubNamespace: typeof import("./eventHubNamespace").EventHubNamespace;
...
export declare const EventHubNamespaceAuthorizationRule: typeof import("./eventHubNamespaceAuthorizationRule").EventHubNamespaceAuthorizationRule;
...
export declare const EventhubNamespaceDisasterRecoveryConfig: typeof import("./eventhubNamespaceDisasterRecoveryConfig").EventhubNamespaceDisasterRecoveryConfig;
...
export declare const getConsumeGroup: typeof import("./getConsumeGroup").getConsumeGroup;
export declare const getConsumeGroupOutput: typeof import("./getConsumeGroup").getConsumeGroupOutput;
...
export declare const getEventhubNamespace: typeof import("./getEventhubNamespace").getEventhubNamespace;
export declare const getEventhubNamespaceOutput: typeof import("./getEventhubNamespace").getEventhubNamespaceOutput;
...
export declare const getSas: typeof import("./getSas").getSas;
export declare const getSasOutput: typeof import("./getSas").getSasOutput;
...
export declare const getServiceBusNamespace: typeof import("./getServiceBusNamespace").getServiceBusNamespace;
export declare const getServiceBusNamespaceOutput: typeof import("./getServiceBusNamespace").getServiceBusNamespaceOutput;
...
export declare const NamespaceCustomerManagedKey: typeof import("./namespaceCustomerManagedKey").NamespaceCustomerManagedKey;
...
export declare const NamespaceSchemaGroup: typeof import("./namespaceSchemaGroup").NamespaceSchemaGroup;
...
export declare const SubscriptionRule: typeof import("./subscriptionRule").SubscriptionRule;
