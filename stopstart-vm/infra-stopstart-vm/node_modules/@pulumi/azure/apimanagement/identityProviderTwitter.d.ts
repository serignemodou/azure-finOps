 ...
 * ```
 */
export declare class IdentityProviderTwitter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityProviderTwitterState, opts?: pulumi.CustomResourceOptions): IdentityProviderTwitter;
    /**
     * Returns true if the given object is an instance of IdentityProviderTwitter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IdentityProviderTwitter;
    /**
     ...
     */
    readonly apiSecretKey: pulumi.Output<string>;
    /**
