...
export declare class GatewayHostNameConfiguration extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GatewayHostNameConfigurationState, opts?: pulumi.CustomResourceOptions): GatewayHostNameConfiguration;
    /**
     ...
     */
    readonly requestClientCertificateEnabled: pulumi.Output<boolean | undefined>;
    /**
