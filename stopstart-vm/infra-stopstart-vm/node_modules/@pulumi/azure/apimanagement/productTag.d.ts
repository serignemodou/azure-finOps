 ...
 * ```
 */
export declare class ProductTag extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProductTagState, opts?: pulumi.CustomResourceOptions): ProductTag;
    /**
     * Returns true if the given object is an instance of ProductTag.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProductTag;
    /**
     ...
     */
    readonly apiManagementProductId: pulumi.Output<string>;
    /**
