 ...
 * ```
 */
export declare class IdentityProviderFacebook extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityProviderFacebookState, opts?: pulumi.CustomResourceOptions): IdentityProviderFacebook;
    /**
     * Returns true if the given object is an instance of IdentityProviderFacebook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IdentityProviderFacebook;
    /**
