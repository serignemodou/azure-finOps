 ...
 * ```
 */
export declare class ScheduledQueryRulesAlertV2 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScheduledQueryRulesAlertV2State, opts?: pulumi.CustomResourceOptions): ScheduledQueryRulesAlertV2;
    /**
     ...
     */
    static isInstance(obj: any): obj is ScheduledQueryRulesAlertV2;
    /**
     * An `action` block as defined below.
     */
    readonly action: pulumi.Output<outputs.monitoring.ScheduledQueryRulesAlertV2Action | undefined>;
    /**
     ...
     */
    readonly criterias: pulumi.Output<outputs.monitoring.ScheduledQueryRulesAlertV2Criteria[]>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.monitoring.ScheduledQueryRulesAlertV2Identity | undefined>;
    /**
     * True if this alert rule is a legacy Log Analytic Rule.
     */
    readonly isALegacyLogAnalyticsRule: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly muteActionsAfterAlertDuration: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly queryTimeRangeOverride: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly windowDuration: pulumi.Output<string>;
    /**
     ...
     */
    readonly workspaceAlertsStorageEnabled: pulumi.Output<boolean | undefined>;
    /**
