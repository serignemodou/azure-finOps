...
export declare class DiagnosticSetting extends pulumi.CustomResource {
     ...
     */
    readonly enabledLogs: pulumi.Output<outputs.monitoring.DiagnosticSettingEnabledLog[] | undefined>;
    /**
     * One or more `enabledMetric` blocks as defined below.
     *
     * > **Note:** At least one `enabledLog` or `enabledMetric` block must be specified.
     */
    readonly enabledMetrics: pulumi.Output<outputs.monitoring.DiagnosticSettingEnabledMetric[]>;
    /**
     ...
     */
    readonly logAnalyticsDestinationType: pulumi.Output<string>;
    /**
     ...
     */
    readonly metrics: pulumi.Output<outputs.monitoring.DiagnosticSettingMetric[]>;
    /**
     ...
     * > **NOTE:** At least one of `eventhubAuthorizationRuleId`, `logAnalyticsWorkspaceId`, `partnerSolutionId` and `storageAccountId` must be specified.
     */
    readonly partnerSolutionId: pulumi.Output<string | undefined>;
    /**
