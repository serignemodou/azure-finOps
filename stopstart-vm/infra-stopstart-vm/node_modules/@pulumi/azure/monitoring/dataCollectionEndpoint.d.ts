...
export declare class DataCollectionEndpoint extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataCollectionEndpointState, opts?: pulumi.CustomResourceOptions): DataCollectionEndpoint;
    /**
     ...
     */
    readonly configurationAccessEndpoint: pulumi.Output<string>;
    /**
     ...
     */
    readonly logsIngestionEndpoint: pulumi.Output<string>;
    /**
     * The endpoint used for ingesting metrics, e.g., `https://mydce-abcd.eastus-1.metrics.ingest.monitor.azure.com`.
     */
    readonly metricsIngestionEndpoint: pulumi.Output<string>;
    /**
