 ...
 * ```
 */
export declare class AlertPrometheusRuleGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertPrometheusRuleGroupState, opts?: pulumi.CustomResourceOptions): AlertPrometheusRuleGroup;
    /**
     * Returns true if the given object is an instance of AlertPrometheusRuleGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AlertPrometheusRuleGroup;
    /**
     ...
     */
    readonly ruleGroupEnabled: pulumi.Output<boolean | undefined>;
    /**
     * One or more `rule` blocks as defined below.
     */
    readonly rules: pulumi.Output<outputs.monitoring.AlertPrometheusRuleGroupRule[]>;
    /**
