 ...
 * ```
 */
export declare class AlertProcessingRuleActionGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertProcessingRuleActionGroupState, opts?: pulumi.CustomResourceOptions): AlertProcessingRuleActionGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is AlertProcessingRuleActionGroup;
    /**
     * Specifies a list of Action Group IDs.
     */
    readonly addActionGroupIds: pulumi.Output<string[]>;
    /**
     * A `condition` block as defined below.
     */
    readonly condition: pulumi.Output<outputs.monitoring.AlertProcessingRuleActionGroupCondition | undefined>;
    /**
     ...
     */
    readonly schedule: pulumi.Output<outputs.monitoring.AlertProcessingRuleActionGroupSchedule | undefined>;
    /**
