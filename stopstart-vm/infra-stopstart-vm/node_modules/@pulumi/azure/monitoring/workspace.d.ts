...
export declare class Workspace extends pulumi.CustomResource {
     ...
     */
    readonly defaultDataCollectionEndpointId: pulumi.Output<string>;
    /**
     * The ID of the managed default Data Collection Rule created with the Azure Monitor Workspace.
     */
    readonly defaultDataCollectionRuleId: pulumi.Output<string>;
    /**
     ...
     */
    readonly queryEndpoint: pulumi.Output<string>;
    /**
