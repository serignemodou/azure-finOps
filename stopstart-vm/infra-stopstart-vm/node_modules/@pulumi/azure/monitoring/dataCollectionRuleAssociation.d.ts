...
export declare class DataCollectionRuleAssociation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataCollectionRuleAssociationState, opts?: pulumi.CustomResourceOptions): DataCollectionRuleAssociation;
    /**
