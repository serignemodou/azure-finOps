...
export declare class CollectorPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CollectorPolicyState, opts?: pulumi.CustomResourceOptions): CollectorPolicy;
    /**
     ...
     */
    readonly ipfxEmission: pulumi.Output<outputs.networkfunction.CollectorPolicyIpfxEmission>;
    /**
     * An `ipfxIngestion` block as defined below. Changing this forces a new Network Function Collector Policy to be created.
     */
    readonly ipfxIngestion: pulumi.Output<outputs.networkfunction.CollectorPolicyIpfxIngestion>;
    /**
     ...
     */
    readonly trafficCollectorId: pulumi.Output<string>;
    /**
