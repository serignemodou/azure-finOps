...
export declare class AzureTrafficCollector extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AzureTrafficCollectorState, opts?: pulumi.CustomResourceOptions): AzureTrafficCollector;
    /**
     ...
     */
    readonly collectorPolicyIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly virtualHubIds: pulumi.Output<string[]>;
    /**
