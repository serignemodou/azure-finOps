...
exports.CacheNfsTarget = exports.CacheBlobTarget = exports.CacheBlobNfsTarget = exports.CacheAccessPolicy = exports.Cache = void 0;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:hpc/cacheBlobNfsTarget:CacheBlobNfsTarget":
                return new exports.CacheBlobNfsTarget(name, undefined, { urn });
            case "azure:hpc/cacheBlobTarget:CacheBlobTarget":
                return new exports.CacheBlobTarget(name, undefined, { urn });
            case "azure:hpc/cacheNfsTarget:CacheNfsTarget":
                return new exports.CacheNfsTarget(name, undefined, { urn });
            default:
