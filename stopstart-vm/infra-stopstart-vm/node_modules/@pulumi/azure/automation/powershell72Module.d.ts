...
export declare class Powershell72Module extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Powershell72ModuleState, opts?: pulumi.CustomResourceOptions): Powershell72Module;
    /**
     ...
     */
    readonly moduleLink: pulumi.Output<outputs.automation.Powershell72ModuleModuleLink>;
    /**
