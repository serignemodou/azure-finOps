...
export declare class Watcher extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WatcherState, opts?: pulumi.CustomResourceOptions): Watcher;
    /**
     ...
     */
    readonly executionFrequencyInSeconds: pulumi.Output<number>;
    /**
     ...
     */
    readonly scriptRunOn: pulumi.Output<string>;
    /**
