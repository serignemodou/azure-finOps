...
export declare class ConnectionType extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionTypeState, opts?: pulumi.CustomResourceOptions): ConnectionType;
    /**
     ...
     */
    readonly fields: pulumi.Output<outputs.automation.ConnectionTypeField[]>;
    /**
