 ...
 * ```
 */
export declare class VolumeGroupSapHana extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeGroupSapHanaState, opts?: pulumi.CustomResourceOptions): VolumeGroupSapHana;
    /**
     * Returns true if the given object is an instance of VolumeGroupSapHana.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeGroupSapHana;
    /**
     ...
     */
    readonly volumes: pulumi.Output<outputs.netapp.VolumeGroupSapHanaVolume[]>;
    /**
