 ...
 * ```
 */
export declare class VolumeGroupOracle extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeGroupOracleState, opts?: pulumi.CustomResourceOptions): VolumeGroupOracle;
    /**
     * Returns true if the given object is an instance of VolumeGroupOracle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeGroupOracle;
    /**
     ...
     */
    readonly volumes: pulumi.Output<outputs.netapp.VolumeGroupOracleVolume[]>;
    /**
