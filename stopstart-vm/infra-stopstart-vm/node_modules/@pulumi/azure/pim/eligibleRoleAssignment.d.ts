 ...
 * ```
 */
export declare class EligibleRoleAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EligibleRoleAssignmentState, opts?: pulumi.CustomResourceOptions): EligibleRoleAssignment;
    /**
     ...
     */
    readonly ticket: pulumi.Output<outputs.pim.EligibleRoleAssignmentTicket>;
    /**
