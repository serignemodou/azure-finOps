 ...
 * ```
 */
export declare class PostgresqlRole extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlRoleState, opts?: pulumi.CustomResourceOptions): PostgresqlRole;
    /**
     * Returns true if the given object is an instance of PostgresqlRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PostgresqlRole;
    /**
