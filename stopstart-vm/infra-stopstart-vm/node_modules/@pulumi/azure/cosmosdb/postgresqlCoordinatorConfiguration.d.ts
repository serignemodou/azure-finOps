 ...
 * ```
 */
export declare class PostgresqlCoordinatorConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlCoordinatorConfigurationState, opts?: pulumi.CustomResourceOptions): PostgresqlCoordinatorConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is PostgresqlCoordinatorConfiguration;
    /**
