 ...
 * ```
 */
export declare class MongoUserDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MongoUserDefinitionState, opts?: pulumi.CustomResourceOptions): MongoUserDefinition;
    /**
     * Returns true if the given object is an instance of MongoUserDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MongoUserDefinition;
    /**
