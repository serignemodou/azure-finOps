 ...
 * ```
 */
export declare class PostgresqlFirewallRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlFirewallRuleState, opts?: pulumi.CustomResourceOptions): PostgresqlFirewallRule;
    /**
     * Returns true if the given object is an instance of PostgresqlFirewallRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PostgresqlFirewallRule;
    /**
