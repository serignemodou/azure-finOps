 ...
 * ```
 */
export declare class PostgresqlNodeConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlNodeConfigurationState, opts?: pulumi.CustomResourceOptions): PostgresqlNodeConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is PostgresqlNodeConfiguration;
    /**
