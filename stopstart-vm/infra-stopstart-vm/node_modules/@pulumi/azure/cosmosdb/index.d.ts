...
export declare const CassandraKeyspace: typeof import("./cassandraKeyspace").CassandraKeyspace;
...
export declare const CassandraTable: typeof import("./cassandraTable").CassandraTable;
...
export declare const getMongoDatabase: typeof import("./getMongoDatabase").getMongoDatabase;
export declare const getMongoDatabaseOutput: typeof import("./getMongoDatabase").getMongoDatabaseOutput;
...
export declare const getRestorableDatabaseAccounts: typeof import("./getRestorableDatabaseAccounts").getRestorableDatabaseAccounts;
export declare const getRestorableDatabaseAccountsOutput: typeof import("./getRestorableDatabaseAccounts").getRestorableDatabaseAccountsOutput;
export { GetSqlDatabaseArgs, GetSqlDatabaseResult, GetSqlDatabaseOutputArgs } from "./getSqlDatabase";
export declare const getSqlDatabase: typeof import("./getSqlDatabase").getSqlDatabase;
export declare const getSqlDatabaseOutput: typeof import("./getSqlDatabase").getSqlDatabaseOutput;
export { GetSqlRoleDefinitionArgs, GetSqlRoleDefinitionResult, GetSqlRoleDefinitionOutputArgs } from "./getSqlRoleDefinition";
export declare const getSqlRoleDefinition: typeof import("./getSqlRoleDefinition").getSqlRoleDefinition;
export declare const getSqlRoleDefinitionOutput: typeof import("./getSqlRoleDefinition").getSqlRoleDefinitionOutput;
...
export declare const GremlinDatabase: typeof import("./gremlinDatabase").GremlinDatabase;
export { GremlinGraphArgs, GremlinGraphState } from "./gremlinGraph";
export type GremlinGraph = import("./gremlinGraph").GremlinGraph;
export declare const GremlinGraph: typeof import("./gremlinGraph").GremlinGraph;
...
export declare const MongoCollection: typeof import("./mongoCollection").MongoCollection;
...
export declare const MongoDatabase: typeof import("./mongoDatabase").MongoDatabase;
...
export declare const MongoRoleDefinition: typeof import("./mongoRoleDefinition").MongoRoleDefinition;
...
export declare const MongoUserDefinition: typeof import("./mongoUserDefinition").MongoUserDefinition;
...
export declare const PostgresqlCluster: typeof import("./postgresqlCluster").PostgresqlCluster;
...
export declare const PostgresqlCoordinatorConfiguration: typeof import("./postgresqlCoordinatorConfiguration").PostgresqlCoordinatorConfiguration;
...
export declare const PostgresqlNodeConfiguration: typeof import("./postgresqlNodeConfiguration").PostgresqlNodeConfiguration;
...
export declare const SqlDedicatedGateway: typeof import("./sqlDedicatedGateway").SqlDedicatedGateway;
export { SqlFunctionArgs, SqlFunctionState } from "./sqlFunction";
export type SqlFunction = import("./sqlFunction").SqlFunction;
export declare const SqlFunction: typeof import("./sqlFunction").SqlFunction;
...
export declare const SqlRoleAssignment: typeof import("./sqlRoleAssignment").SqlRoleAssignment;
...
export declare const SqlRoleDefinition: typeof import("./sqlRoleDefinition").SqlRoleDefinition;
...
export declare const SqlStoredProcedure: typeof import("./sqlStoredProcedure").SqlStoredProcedure;
export { SqlTriggerArgs, SqlTriggerState } from "./sqlTrigger";
export type SqlTrigger = import("./sqlTrigger").SqlTrigger;
export declare const SqlTrigger: typeof import("./sqlTrigger").SqlTrigger;
