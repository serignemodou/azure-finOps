 ...
 * ```
 */
export declare class CaaRecord extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaaRecordState, opts?: pulumi.CustomResourceOptions): CaaRecord;
    /**
     * Returns true if the given object is an instance of CaaRecord.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CaaRecord;
    /**
     ...
     */
    readonly records: pulumi.Output<outputs.dns.CaaRecordRecord[]>;
    /**
