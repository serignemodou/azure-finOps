 ...
 * ```
 */
export declare class ApplicationNetworkRuleSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationNetworkRuleSetState, opts?: pulumi.CustomResourceOptions): ApplicationNetworkRuleSet;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationNetworkRuleSet;
    /**
     ...
     */
    readonly applyToDevice: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly ipRules: pulumi.Output<outputs.iotcentral.ApplicationNetworkRuleSetIpRule[] | undefined>;
    /**
