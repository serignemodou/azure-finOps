...
exports.Organization = exports.ApplicationNetworkRuleSet = exports.Application = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.Application = null;
utilities.lazyLoad(exports, ["Application"], () => require("./application"));
exports.ApplicationNetworkRuleSet = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:iotcentral/applicationNetworkRuleSet:ApplicationNetworkRuleSet":
                return new exports.ApplicationNetworkRuleSet(name, undefined, { urn });
