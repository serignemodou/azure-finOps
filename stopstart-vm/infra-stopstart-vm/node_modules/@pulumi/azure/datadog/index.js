...
exports.MonitorTagRule = exports.MonitorSsoConfiguration = exports.Monitor = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.Monitor = null;
utilities.lazyLoad(exports, ["Monitor"], () => require("./monitor"));
exports.MonitorSsoConfiguration = null;
utilities.lazyLoad(exports, ["MonitorSsoConfiguration"], () => require("./monitorSsoConfiguration"));
exports.MonitorTagRule = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:datadog/monitorSsoConfiguration:MonitorSsoConfiguration":
                return new exports.MonitorSsoConfiguration(name, undefined, { urn });
            case "azure:datadog/monitorTagRule:MonitorTagRule":
                return new exports.MonitorTagRule(name, undefined, { urn });
            default:
