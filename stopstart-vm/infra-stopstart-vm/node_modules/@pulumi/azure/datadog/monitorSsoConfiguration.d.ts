 ...
 * ```
 */
export declare class MonitorSsoConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitorSsoConfigurationState, opts?: pulumi.CustomResourceOptions): MonitorSsoConfiguration;
    /**
     * Returns true if the given object is an instance of MonitorSsoConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MonitorSsoConfiguration;
    /**
     ...
     */
    readonly enterpriseApplicationId: pulumi.Output<string>;
    /**
