 ...
 * ```
 */
export declare class MonitorTagRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitorTagRuleState, opts?: pulumi.CustomResourceOptions): MonitorTagRule;
    /**
     * Returns true if the given object is an instance of MonitorTagRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MonitorTagRule;
    /**
     ...
     */
    readonly datadogMonitorId: pulumi.Output<string>;
    /**
     * A `log` block as defined below.
     */
    readonly logs: pulumi.Output<outputs.datadog.MonitorTagRuleLog[] | undefined>;
    /**
     * A `metric` block as defined below.
     */
    readonly metrics: pulumi.Output<outputs.datadog.MonitorTagRuleMetric[] | undefined>;
    /**
