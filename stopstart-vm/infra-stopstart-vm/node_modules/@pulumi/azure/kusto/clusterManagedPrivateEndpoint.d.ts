 ...
 * ```
 */
export declare class ClusterManagedPrivateEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterManagedPrivateEndpointState, opts?: pulumi.CustomResourceOptions): ClusterManagedPrivateEndpoint;
    /**
     ...
     */
    static isInstance(obj: any): obj is ClusterManagedPrivateEndpoint;
    /**
