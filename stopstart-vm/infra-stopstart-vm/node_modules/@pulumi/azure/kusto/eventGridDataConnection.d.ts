...
export declare class EventGridDataConnection extends pulumi.CustomResource {
     ...
     */
    readonly eventgridEventSubscriptionId: pulumi.Output<string>;
    /**
     ...
     */
    readonly eventgridResourceId: pulumi.Output<string>;
    /**
     ...
     */
    readonly managedIdentityId: pulumi.Output<string>;
    /**
