 ...
 * ```
 */
export declare class ResourceBridgeAppliance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceBridgeApplianceState, opts?: pulumi.CustomResourceOptions): ResourceBridgeAppliance;
    /**
     * Returns true if the given object is an instance of ResourceBridgeAppliance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResourceBridgeAppliance;
    /**
     * Specifies a supported Fabric/Infrastructure for this Arc Resource Bridge Appliance. The possible value is `AKSEdge`.
     */
    readonly distro: pulumi.Output<string>;
    /**
     * An `identity` block as defined below. Changing this forces a new resource to be created.
     */
    readonly identity: pulumi.Output<outputs.arc.ResourceBridgeApplianceIdentity>;
    /**
     ...
     */
    readonly infrastructureProvider: pulumi.Output<string>;
    /**
     ...
     */
    readonly publicKeyBase64: pulumi.Output<string | undefined>;
    /**
