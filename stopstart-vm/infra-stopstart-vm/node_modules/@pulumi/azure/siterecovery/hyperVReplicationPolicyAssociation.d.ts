 ...
 * ```
 */
export declare class HyperVReplicationPolicyAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HyperVReplicationPolicyAssociationState, opts?: pulumi.CustomResourceOptions): HyperVReplicationPolicyAssociation;
    /**
