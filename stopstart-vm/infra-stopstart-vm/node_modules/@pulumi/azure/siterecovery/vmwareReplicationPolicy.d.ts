 ...
 * ```
 */
export declare class VMWareReplicationPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VMWareReplicationPolicyState, opts?: pulumi.CustomResourceOptions): VMWareReplicationPolicy;
    /**
     * Returns true if the given object is an instance of VMWareReplicationPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VMWareReplicationPolicy;
    /**
