 ...
 * ```
 */
export declare class HyperVReplicationPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HyperVReplicationPolicyState, opts?: pulumi.CustomResourceOptions): HyperVReplicationPolicy;
    /**
     * Returns true if the given object is an instance of HyperVReplicationPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HyperVReplicationPolicy;
    /**
     * Specifies the frequency at which to create application consistent recovery points.
     */
    readonly applicationConsistentSnapshotFrequencyInHours: pulumi.Output<number>;
    /**
     ...
     */
    readonly recoveryPointRetentionInHours: pulumi.Output<number>;
    /**
     ...
     */
    readonly replicationIntervalInSeconds: pulumi.Output<number>;
    /**
