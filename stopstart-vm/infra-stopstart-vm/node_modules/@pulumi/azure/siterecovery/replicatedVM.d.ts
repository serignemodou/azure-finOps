...
export declare class ReplicatedVM extends pulumi.CustomResource {
     ...
     */
    readonly managedDisks: pulumi.Output<outputs.siterecovery.ReplicatedVMManagedDisk[]>;
    /**
     ...
     */
    readonly targetBootDiagnosticStorageAccountId: pulumi.Output<string | undefined>;
    /**
     * Id of the Capacity reservation group where the new VM should belong to when a failover is done.
     */
    readonly targetCapacityReservationGroupId: pulumi.Output<string | undefined>;
    /**
     * Specifies the Edge Zone within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
     */
    readonly targetEdgeZone: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly targetVirtualMachineScaleSetId: pulumi.Output<string | undefined>;
    /**
     * Specifies the size the Virtual Machine should have.
     */
    readonly targetVirtualMachineSize: pulumi.Output<string>;
    /**
     ...
     */
    readonly testNetworkId: pulumi.Output<string>;
    /**
     * One or more `unmanagedDisk` block as defined below. Changing this forces a new resource to be created.
     */
    readonly unmanagedDisks: pulumi.Output<outputs.siterecovery.ReplicatedVMUnmanagedDisk[]>;
    /**
