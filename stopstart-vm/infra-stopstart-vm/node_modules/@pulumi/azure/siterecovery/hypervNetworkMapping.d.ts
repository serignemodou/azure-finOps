 ...
 * ```
 */
export declare class HypervNetworkMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HypervNetworkMappingState, opts?: pulumi.CustomResourceOptions): HypervNetworkMapping;
    /**
     * Returns true if the given object is an instance of HypervNetworkMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HypervNetworkMapping;
    /**
     ...
     */
    readonly sourceNetworkName: pulumi.Output<string>;
    /**
     ...
     */
    readonly sourceSystemCenterVirtualMachineManagerName: pulumi.Output<string>;
    /**
