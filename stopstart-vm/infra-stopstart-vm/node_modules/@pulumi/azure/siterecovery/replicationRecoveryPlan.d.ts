...
export declare class ReplicationRecoveryPlan extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicationRecoveryPlanState, opts?: pulumi.CustomResourceOptions): ReplicationRecoveryPlan;
    /**
     ...
     */
    readonly azureToAzureSettings: pulumi.Output<outputs.siterecovery.ReplicationRecoveryPlanAzureToAzureSettings | undefined>;
    /**
     * One or more `bootRecoveryGroup` blocks as defined below.
     */
    readonly bootRecoveryGroups: pulumi.Output<outputs.siterecovery.ReplicationRecoveryPlanBootRecoveryGroup[]>;
    /**
     * One `failoverRecoveryGroup` block as defined below.
     */
    readonly failoverRecoveryGroup: pulumi.Output<outputs.siterecovery.ReplicationRecoveryPlanFailoverRecoveryGroup>;
    /**
     ...
     */
    readonly shutdownRecoveryGroup: pulumi.Output<outputs.siterecovery.ReplicationRecoveryPlanShutdownRecoveryGroup>;
    /**
     * ID of source fabric to be recovered from. Changing this forces a new Replication Plan to be created.
     */
    readonly sourceRecoveryFabricId: pulumi.Output<string>;
    /**
