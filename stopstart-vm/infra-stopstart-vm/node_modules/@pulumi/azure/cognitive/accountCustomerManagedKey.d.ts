 ...
 * ```
 */
export declare class AccountCustomerManagedKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountCustomerManagedKeyState, opts?: pulumi.CustomResourceOptions): AccountCustomerManagedKey;
    /**
     ...
     */
    static isInstance(obj: any): obj is AccountCustomerManagedKey;
    /**
     ...
     */
    readonly identityClientId: pulumi.Output<string | undefined>;
    /**
