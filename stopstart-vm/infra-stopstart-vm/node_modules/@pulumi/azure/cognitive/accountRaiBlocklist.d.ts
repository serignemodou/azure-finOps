 ...
 * ```
 */
export declare class AccountRaiBlocklist extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountRaiBlocklistState, opts?: pulumi.CustomResourceOptions): AccountRaiBlocklist;
    /**
     * Returns true if the given object is an instance of AccountRaiBlocklist.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AccountRaiBlocklist;
    /**
