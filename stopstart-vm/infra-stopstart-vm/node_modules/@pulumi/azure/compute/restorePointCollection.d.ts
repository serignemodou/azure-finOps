...
export declare class RestorePointCollection extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestorePointCollectionState, opts?: pulumi.CustomResourceOptions): RestorePointCollection;
    /**
     ...
     */
    readonly sourceVirtualMachineId: pulumi.Output<string>;
    /**
