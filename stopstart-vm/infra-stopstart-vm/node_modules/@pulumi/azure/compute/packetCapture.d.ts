...
export declare class PacketCapture extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PacketCaptureState, opts?: pulumi.CustomResourceOptions): PacketCapture;
    /**
     ...
     */
    readonly filters: pulumi.Output<outputs.compute.PacketCaptureFilter[] | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.compute.PacketCaptureStorageLocation>;
    /**
