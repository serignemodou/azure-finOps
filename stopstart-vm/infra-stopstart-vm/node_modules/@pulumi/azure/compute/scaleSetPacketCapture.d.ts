 ...
 * ```
 */
export declare class ScaleSetPacketCapture extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScaleSetPacketCaptureState, opts?: pulumi.CustomResourceOptions): ScaleSetPacketCapture;
    /**
     * Returns true if the given object is an instance of ScaleSetPacketCapture.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScaleSetPacketCapture;
    /**
     * One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
     */
    readonly filters: pulumi.Output<outputs.compute.ScaleSetPacketCaptureFilter[] | undefined>;
    /**
     * A `machineScope` block as defined below. Changing this forces a new resource to be created.
     */
    readonly machineScope: pulumi.Output<outputs.compute.ScaleSetPacketCaptureMachineScope | undefined>;
    /**
     ...
     */
    readonly maximumCaptureDurationInSeconds: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly storageLocation: pulumi.Output<outputs.compute.ScaleSetPacketCaptureStorageLocation>;
    /**
