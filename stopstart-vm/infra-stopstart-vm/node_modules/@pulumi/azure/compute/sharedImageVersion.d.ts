 ...
 * ```
 */
export declare class SharedImageVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SharedImageVersionState, opts?: pulumi.CustomResourceOptions): SharedImageVersion;
    /**
     * Returns true if the given object is an instance of SharedImageVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SharedImageVersion;
    /**
     ...
     */
    readonly blobUri: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly deletionOfReplicatedLocationsEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     * > **NOTE:** You must specify exact one of `blobUri`, `managedImageId` and `osDiskSnapshotId`.
     */
    readonly osDiskSnapshotId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly targetRegions: pulumi.Output<outputs.compute.SharedImageVersionTargetRegion[]>;
    /**
