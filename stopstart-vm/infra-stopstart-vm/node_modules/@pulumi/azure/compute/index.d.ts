...
export declare const DataDiskAttachment: typeof import("./dataDiskAttachment").DataDiskAttachment;
...
export declare const GalleryApplicationAssignment: typeof import("./galleryApplicationAssignment").GalleryApplicationAssignment;
...
export declare const getConfidentialLedger: typeof import("./getConfidentialLedger").getConfidentialLedger;
export declare const getConfidentialLedgerOutput: typeof import("./getConfidentialLedger").getConfidentialLedgerOutput;
...
export declare const getOrchestratedVirtualMachineScaleSet: typeof import("./getOrchestratedVirtualMachineScaleSet").getOrchestratedVirtualMachineScaleSet;
...
export declare const getPlatformImage: typeof import("./getPlatformImage").getPlatformImage;
export declare const getPlatformImageOutput: typeof import("./getPlatformImage").getPlatformImageOutput;
export { GetSharedImageArgs, GetSharedImageResult, GetSharedImageOutputArgs } from "./getSharedImage";
export declare const getSharedImage: typeof import("./getSharedImage").getSharedImage;
export declare const getSharedImageOutput: typeof import("./getSharedImage").getSharedImageOutput;
export { GetSharedImageGalleryArgs, GetSharedImageGalleryResult, GetSharedImageGalleryOutputArgs } from "./getSharedImageGallery";
export declare const getSharedImageGallery: typeof import("./getSharedImageGallery").getSharedImageGallery;
...
export declare const getSharedImageVersion: typeof import("./getSharedImageVersion").getSharedImageVersion;
export declare const getSharedImageVersionOutput: typeof import("./getSharedImageVersion").getSharedImageVersionOutput;
...
export declare const getSharedImageVersions: typeof import("./getSharedImageVersions").getSharedImageVersions;
export declare const getSharedImageVersionsOutput: typeof import("./getSharedImageVersions").getSharedImageVersionsOutput;
...
export declare const ImplicitDataDiskFromSource: typeof import("./implicitDataDiskFromSource").ImplicitDataDiskFromSource;
...
export declare const LinuxVirtualMachine: typeof import("./linuxVirtualMachine").LinuxVirtualMachine;
...
export declare const LinuxVirtualMachineScaleSet: typeof import("./linuxVirtualMachineScaleSet").LinuxVirtualMachineScaleSet;
export { ManagedDiskArgs, ManagedDiskState } from "./managedDisk";
export type ManagedDisk = import("./managedDisk").ManagedDisk;
export declare const ManagedDisk: typeof import("./managedDisk").ManagedDisk;
...
export declare const ManagedDiskSasToken: typeof import("./managedDiskSasToken").ManagedDiskSasToken;
...
export declare const OrchestratedVirtualMachineScaleSet: typeof import("./orchestratedVirtualMachineScaleSet").OrchestratedVirtualMachineScaleSet;
...
export declare const RunCommand: typeof import("./runCommand").RunCommand;
export { ScaleSetArgs, ScaleSetState } from "./scaleSet";
export type ScaleSet = import("./scaleSet").ScaleSet;
export declare const ScaleSet: typeof import("./scaleSet").ScaleSet;
...
export declare const ScaleSetPacketCapture: typeof import("./scaleSetPacketCapture").ScaleSetPacketCapture;
...
export declare const ScaleSetStandbyPool: typeof import("./scaleSetStandbyPool").ScaleSetStandbyPool;
export { SharedImageArgs, SharedImageState } from "./sharedImage";
export type SharedImage = import("./sharedImage").SharedImage;
export declare const SharedImage: typeof import("./sharedImage").SharedImage;
...
export declare const SharedImageGallery: typeof import("./sharedImageGallery").SharedImageGallery;
...
export declare const SharedImageVersion: typeof import("./sharedImageVersion").SharedImageVersion;
...
export declare const WindowsVirtualMachine: typeof import("./windowsVirtualMachine").WindowsVirtualMachine;
...
export declare const WindowsVirtualMachineScaleSet: typeof import("./windowsVirtualMachineScaleSet").WindowsVirtualMachineScaleSet;
