...
export declare class Snapshot extends pulumi.CustomResource {
     ...
     */
    readonly encryptionSettings: pulumi.Output<outputs.compute.SnapshotEncryptionSettings | undefined>;
    /**
     * Specifies if the Snapshot is incremental. Changing this forces a new resource to be created.
     */
    readonly incrementalEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly trustedLaunchEnabled: pulumi.Output<boolean>;
    /**
