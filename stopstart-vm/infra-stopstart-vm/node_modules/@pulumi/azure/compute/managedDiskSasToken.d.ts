 ...
 * ```
 */
export declare class ManagedDiskSasToken extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDiskSasTokenState, opts?: pulumi.CustomResourceOptions): ManagedDiskSasToken;
    /**
     * Returns true if the given object is an instance of ManagedDiskSasToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedDiskSasToken;
    /**
     ...
     */
    readonly sasUrl: pulumi.Output<string>;
    /**
