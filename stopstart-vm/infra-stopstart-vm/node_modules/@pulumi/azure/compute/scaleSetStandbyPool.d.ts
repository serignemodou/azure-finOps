 ...
 * ```
 */
export declare class ScaleSetStandbyPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScaleSetStandbyPoolState, opts?: pulumi.CustomResourceOptions): ScaleSetStandbyPool;
    /**
     * Returns true if the given object is an instance of ScaleSetStandbyPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScaleSetStandbyPool;
    /**
     * Specifies the fully qualified resource ID of a virtual machine scale set the pool is attached to.
     */
    readonly attachedVirtualMachineScaleSetId: pulumi.Output<string>;
    /**
     * An `elasticityProfile` block as defined below.
     */
    readonly elasticityProfile: pulumi.Output<outputs.compute.ScaleSetStandbyPoolElasticityProfile>;
    /**
