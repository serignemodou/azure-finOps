 ...
 * ```
 */
export declare class BackupInstanceKubernetesCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupInstanceKubernetesClusterState, opts?: pulumi.CustomResourceOptions): BackupInstanceKubernetesCluster;
    /**
