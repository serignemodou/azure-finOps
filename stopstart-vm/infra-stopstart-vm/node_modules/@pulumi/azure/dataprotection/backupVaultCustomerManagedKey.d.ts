 ...
 * ```
 */
export declare class BackupVaultCustomerManagedKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupVaultCustomerManagedKeyState, opts?: pulumi.CustomResourceOptions): BackupVaultCustomerManagedKey;
    /**
     ...
     */
    static isInstance(obj: any): obj is BackupVaultCustomerManagedKey;
    /**
     * The ID of the Backup Vault. Changing this forces a new resource to be created.
     */
    readonly dataProtectionBackupVaultId: pulumi.Output<string>;
    /**
