...
export declare class ResourceGuard extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceGuardState, opts?: pulumi.CustomResourceOptions): ResourceGuard;
    /**
     ...
     */
    readonly vaultCriticalOperationExclusionLists: pulumi.Output<string[] | undefined>;
    /**
