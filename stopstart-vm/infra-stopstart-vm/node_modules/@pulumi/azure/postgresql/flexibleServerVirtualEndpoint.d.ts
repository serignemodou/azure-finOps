 ...
 * ```
 */
export declare class FlexibleServerVirtualEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FlexibleServerVirtualEndpointState, opts?: pulumi.CustomResourceOptions): FlexibleServerVirtualEndpoint;
    /**
