...
exports.EndpointCosmosdbAccount = void 0;
...
class EndpointCosmosdbAccount extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new EndpointCosmosdbAccount(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["primaryKey"] = (args === null || args === void 0 ? void 0 : args.primaryKey) ? pulumi.secret(args.primaryKey) : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["secondaryKey"] = (args === null || args === void 0 ? void 0 : args.secondaryKey) ? pulumi.secret(args.secondaryKey) : undefined;
        }
...
exports.EndpointCosmosdbAccount = EndpointCosmosdbAccount;
/** @internal */
EndpointCosmosdbAccount.__pulumiType = 'azure:iot/endpointCosmosdbAccount:EndpointCosmosdbAccount';
//# sourceMappingURL=endpointCosmosdbAccount.js.map