 ...
 * ```
 */
export declare class IotHubDeviceUpdateInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IotHubDeviceUpdateInstanceState, opts?: pulumi.CustomResourceOptions): IotHubDeviceUpdateInstance;
    /**
     ...
     */
    static isInstance(obj: any): obj is IotHubDeviceUpdateInstance;
    /**
     ...
     */
    readonly deviceUpdateAccountId: pulumi.Output<string>;
    /**
     * Whether the diagnostic log collection is enabled. Possible values are `true` and `false`. Defaults to `false`.
     */
    readonly diagnosticEnabled: pulumi.Output<boolean | undefined>;
    /**
     * A `diagnosticStorageAccount` block as defined below.
     */
    readonly diagnosticStorageAccount: pulumi.Output<outputs.iot.IotHubDeviceUpdateInstanceDiagnosticStorageAccount | undefined>;
    /**
