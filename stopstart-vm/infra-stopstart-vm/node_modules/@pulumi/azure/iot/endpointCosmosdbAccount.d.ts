 ...
 * ```
 */
export declare class EndpointCosmosdbAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EndpointCosmosdbAccountState, opts?: pulumi.CustomResourceOptions): EndpointCosmosdbAccount;
    /**
     * Returns true if the given object is an instance of EndpointCosmosdbAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EndpointCosmosdbAccount;
    /**
     ...
     */
    readonly partitionKeyName: pulumi.Output<string | undefined>;
    /**
     * The template for generating a synthetic partition key value for use within the Cosmos DB Container.
     */
    readonly partitionKeyTemplate: pulumi.Output<string | undefined>;
    /**
