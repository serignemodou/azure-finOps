 ...
 * ```
 */
export declare class EndpointServicebus extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EndpointServicebusState, opts?: pulumi.CustomResourceOptions): EndpointServicebus;
    /**
     * Returns true if the given object is an instance of EndpointServicebus.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EndpointServicebus;
    /**
     ...
     */
    readonly servicebusPrimaryConnectionString: pulumi.Output<string>;
    /**
     * The secondary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission.
     */
    readonly servicebusSecondaryConnectionString: pulumi.Output<string>;
    /**
