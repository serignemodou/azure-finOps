...
export declare class ProvisionedCluster extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProvisionedClusterState, opts?: pulumi.CustomResourceOptions): ProvisionedCluster;
    /**
     ...
     */
    readonly arcAgentAutoUpgradeEnabled: pulumi.Output<boolean | undefined>;
    /**
     * The version of the Arc agents to be installed on the cluster.
     */
    readonly arcAgentDesiredVersion: pulumi.Output<string | undefined>;
    /**
     * An `azureActiveDirectory` block as defined below.
     */
    readonly azureActiveDirectory: pulumi.Output<outputs.arckubernetes.ProvisionedClusterAzureActiveDirectory | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.arckubernetes.ProvisionedClusterIdentity>;
    /**
