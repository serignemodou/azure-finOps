...
export declare class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly blobStorage: pulumi.Output<outputs.arckubernetes.FluxConfigurationBlobStorage | undefined>;
    /**
     * A `bucket` block as defined below.
     */
    readonly bucket: pulumi.Output<outputs.arckubernetes.FluxConfigurationBucket | undefined>;
    /**
     ...
     */
    readonly gitRepository: pulumi.Output<outputs.arckubernetes.FluxConfigurationGitRepository | undefined>;
    /**
     * A `kustomizations` block as defined below.
     */
    readonly kustomizations: pulumi.Output<outputs.arckubernetes.FluxConfigurationKustomization[]>;
    /**
