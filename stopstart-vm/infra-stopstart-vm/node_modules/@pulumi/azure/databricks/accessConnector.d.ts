...
export declare class AccessConnector extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessConnectorState, opts?: pulumi.CustomResourceOptions): AccessConnector;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.databricks.AccessConnectorIdentity | undefined>;
    /**
