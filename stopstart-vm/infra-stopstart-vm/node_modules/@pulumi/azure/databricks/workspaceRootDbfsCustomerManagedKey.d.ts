 ...
 * ```
 */
export declare class WorkspaceRootDbfsCustomerManagedKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkspaceRootDbfsCustomerManagedKeyState, opts?: pulumi.CustomResourceOptions): WorkspaceRootDbfsCustomerManagedKey;
    /**
