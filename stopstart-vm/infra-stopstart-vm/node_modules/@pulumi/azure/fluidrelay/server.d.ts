...
export declare class Server extends pulumi.CustomResource {
     ...
     */
    readonly customerManagedKey: pulumi.Output<outputs.fluidrelay.ServerCustomerManagedKey | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.fluidrelay.ServerIdentity | undefined>;
    /**
     ...
     */
    readonly ordererEndpoints: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly serviceEndpoints: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly storageEndpoints: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly storageSku: pulumi.Output<string>;
    /**
