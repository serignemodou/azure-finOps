 ...
 * ```
 */
export declare class ServiceTrust extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceTrustState, opts?: pulumi.CustomResourceOptions): ServiceTrust;
    /**
     * Returns true if the given object is an instance of ServiceTrust.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceTrust;
    /**
     ...
     */
    readonly trustedDomainDnsIps: pulumi.Output<string[]>;
    /**
     * The FQDN of the on-premise Active Directory Domain Service.
     */
    readonly trustedDomainFqdn: pulumi.Output<string>;
    /**
