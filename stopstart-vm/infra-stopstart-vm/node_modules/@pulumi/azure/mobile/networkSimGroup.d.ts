 ...
 * ```
 */
export declare class NetworkSimGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkSimGroupState, opts?: pulumi.CustomResourceOptions): NetworkSimGroup;
    /**
     * Returns true if the given object is an instance of NetworkSimGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkSimGroup;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.mobile.NetworkSimGroupIdentity | undefined>;
    /**
