 ...
 * ```
 */
class NetworkService extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NetworkService(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
NetworkService.__pulumiType = 'azure:mobile/networkService:NetworkService';
