 ...
 * ```
 */
export declare class NetworkService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkServiceState, opts?: pulumi.CustomResourceOptions): NetworkService;
    /**
     * Returns true if the given object is an instance of NetworkService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkService;
    /**
     ...
     */
    readonly pccRules: pulumi.Output<outputs.mobile.NetworkServicePccRule[]>;
    /**
     ...
     */
    readonly serviceQosPolicy: pulumi.Output<outputs.mobile.NetworkServiceServiceQosPolicy | undefined>;
    /**
