 ...
 * ```
 */
export declare class SubscriptionPolicyRemediation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SubscriptionPolicyRemediationState, opts?: pulumi.CustomResourceOptions): SubscriptionPolicyRemediation;
    /**
     ...
     */
    static isInstance(obj: any): obj is SubscriptionPolicyRemediation;
    /**
