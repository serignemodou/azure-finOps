 ...
 * ```
 */
export declare class ResourceDeploymentScriptPowerShell extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceDeploymentScriptPowerShellState, opts?: pulumi.CustomResourceOptions): ResourceDeploymentScriptPowerShell;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResourceDeploymentScriptPowerShell;
    /**
     ...
     */
    readonly container: pulumi.Output<outputs.core.ResourceDeploymentScriptPowerShellContainer | undefined>;
    /**
     * An `environmentVariable` block as defined below. Changing this forces a new Resource Deployment Script to be created.
     */
    readonly environmentVariables: pulumi.Output<outputs.core.ResourceDeploymentScriptPowerShellEnvironmentVariable[] | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.core.ResourceDeploymentScriptPowerShellIdentity | undefined>;
    /**
     ...
     */
    readonly storageAccount: pulumi.Output<outputs.core.ResourceDeploymentScriptPowerShellStorageAccount | undefined>;
    /**
