 ...
 * ```
 */
export declare class ResourceGroupPolicyRemediation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceGroupPolicyRemediationState, opts?: pulumi.CustomResourceOptions): ResourceGroupPolicyRemediation;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResourceGroupPolicyRemediation;
    /**
