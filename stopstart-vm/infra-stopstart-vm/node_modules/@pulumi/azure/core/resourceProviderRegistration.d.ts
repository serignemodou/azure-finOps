 ...
 * ```
 */
export declare class ResourceProviderRegistration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceProviderRegistrationState, opts?: pulumi.CustomResourceOptions): ResourceProviderRegistration;
    /**
