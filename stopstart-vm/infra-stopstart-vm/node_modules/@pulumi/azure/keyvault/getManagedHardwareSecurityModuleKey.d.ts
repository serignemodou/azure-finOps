 ...
 * ```
 */
export declare function getManagedHardwareSecurityModuleKey(args: GetManagedHardwareSecurityModuleKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedHardwareSecurityModuleKeyResult>;
/**
 ...
 * ```
 */
export declare function getManagedHardwareSecurityModuleKeyOutput(args: GetManagedHardwareSecurityModuleKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedHardwareSecurityModuleKeyResult>;
/**
 * A collection of arguments for invoking getManagedHardwareSecurityModuleKey.
 */
