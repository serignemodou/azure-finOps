 ...
 * ```
 */
export declare class ManagedHardwareSecurityModuleRoleDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedHardwareSecurityModuleRoleDefinitionState, opts?: pulumi.CustomResourceOptions): ManagedHardwareSecurityModuleRoleDefinition;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedHardwareSecurityModuleRoleDefinition;
    /**
     ...
     */
    readonly permissions: pulumi.Output<outputs.keyvault.ManagedHardwareSecurityModuleRoleDefinitionPermission[] | undefined>;
    /**
