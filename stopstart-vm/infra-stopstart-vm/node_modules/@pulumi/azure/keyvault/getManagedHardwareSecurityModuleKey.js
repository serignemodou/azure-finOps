...
exports.getManagedHardwareSecurityModuleKeyOutput = exports.getManagedHardwareSecurityModuleKey = void 0;
 ...
 * ```
 */
function getManagedHardwareSecurityModuleKey(args, opts) {
...
exports.getManagedHardwareSecurityModuleKey = getManagedHardwareSecurityModuleKey;
/**
 * Use this data source to access information about an existing Managed Hardware Security Module Key.
 *
 * > **Note:** All arguments including the secret value will be stored in the raw state as plain-text.
 ...
 * ```
 */
function getManagedHardwareSecurityModuleKeyOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getManagedHardwareSecurityModuleKeyOutput = getManagedHardwareSecurityModuleKeyOutput;
//# sourceMappingURL=getManagedHardwareSecurityModuleKey.js.map