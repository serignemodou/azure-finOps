 ...
 * ```
 */
export declare function getCertificateData(args: GetCertificateDataArgs, opts?: pulumi.InvokeOptions): Promise<GetCertificateDataResult>;
/**
 ...
 * ```
 */
export declare function getCertificateDataOutput(args: GetCertificateDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificateDataResult>;
/**
 * A collection of arguments for invoking getCertificateData.
 */
