 ...
 * ```
 */
export declare class DatasetBlobStorage extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatasetBlobStorageState, opts?: pulumi.CustomResourceOptions): DatasetBlobStorage;
    /**
     * Returns true if the given object is an instance of DatasetBlobStorage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatasetBlobStorage;
    /**
     ...
     */
    readonly dataShareId: pulumi.Output<string>;
    /**
     ...
     */
    readonly storageAccount: pulumi.Output<outputs.datashare.DatasetBlobStorageStorageAccount>;
    /**
