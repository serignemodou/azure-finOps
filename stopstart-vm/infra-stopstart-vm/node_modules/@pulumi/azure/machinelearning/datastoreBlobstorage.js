...
exports.DatastoreBlobstorage = void 0;
...
class DatastoreBlobstorage extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new DatastoreBlobstorage(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sharedAccessSignature"] = (args === null || args === void 0 ? void 0 : args.sharedAccessSignature) ? pulumi.secret(args.sharedAccessSignature) : undefined;
...
exports.DatastoreBlobstorage = DatastoreBlobstorage;
/** @internal */
DatastoreBlobstorage.__pulumiType = 'azure:machinelearning/datastoreBlobstorage:DatastoreBlobstorage';
//# sourceMappingURL=datastoreBlobstorage.js.map