 ...
 * ```
 */
export declare class DatastoreDatalakeGen2 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatastoreDatalakeGen2State, opts?: pulumi.CustomResourceOptions): DatastoreDatalakeGen2;
    /**
     * Returns true if the given object is an instance of DatastoreDatalakeGen2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatastoreDatalakeGen2;
    /**
     * An URL used for authentication.
     */
    readonly authorityUrl: pulumi.Output<string | undefined>;
    /**
