...
export declare class PrivateLinkAssociation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateLinkAssociationState, opts?: pulumi.CustomResourceOptions): PrivateLinkAssociation;
    /**
     ...
     */
    readonly resourceManagementPrivateLinkId: pulumi.Output<string>;
    /**
     * The Tenant ID.
     */
