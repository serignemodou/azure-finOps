...
exports.PrivateLinkAssociation = exports.PrivateLink = exports.Lock = exports.GroupTemplateDeployment = exports.GroupSubscriptionAssociation = exports.GroupPolicyRemediation = exports.GroupPolicyExemption = exports.GroupPolicyAssignment = exports.Group = exports.getGroupTemplateDeploymentOutput = exports.getGroupTemplateDeployment = exports.getGroupOutput = exports.getGroup = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.getGroup = null;
exports.getGroupOutput = null;
utilities.lazyLoad(exports, ["getGroup", "getGroupOutput"], () => require("./getGroup"));
exports.getGroupTemplateDeployment = null;
exports.getGroupTemplateDeploymentOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:management/groupPolicyAssignment:GroupPolicyAssignment":
                return new exports.GroupPolicyAssignment(name, undefined, { urn });
            case "azure:management/groupPolicyExemption:GroupPolicyExemption":
                return new exports.GroupPolicyExemption(name, undefined, { urn });
            case "azure:management/groupPolicyRemediation:GroupPolicyRemediation":
                return new exports.GroupPolicyRemediation(name, undefined, { urn });
            case "azure:management/groupSubscriptionAssociation:GroupSubscriptionAssociation":
                return new exports.GroupSubscriptionAssociation(name, undefined, { urn });
            case "azure:management/groupTemplateDeployment:GroupTemplateDeployment":
                return new exports.GroupTemplateDeployment(name, undefined, { urn });
            case "azure:management/lock:Lock":
                return new exports.Lock(name, undefined, { urn });
