 ...
 * ```
 */
export declare class ScalingPlanHostPoolAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScalingPlanHostPoolAssociationState, opts?: pulumi.CustomResourceOptions): ScalingPlanHostPoolAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is ScalingPlanHostPoolAssociation;
    /**
     ...
     */
    readonly scalingPlanId: pulumi.Output<string>;
    /**
