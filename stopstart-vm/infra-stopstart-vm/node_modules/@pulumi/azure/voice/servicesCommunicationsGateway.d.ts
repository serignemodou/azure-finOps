 ...
 * ```
 */
export declare class ServicesCommunicationsGateway extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicesCommunicationsGatewayState, opts?: pulumi.CustomResourceOptions): ServicesCommunicationsGateway;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServicesCommunicationsGateway;
    /**
     * Details of API bridge functionality, if required.
     */
    readonly apiBridge: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly microsoftTeamsVoicemailPilotNumber: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly serviceLocations: pulumi.Output<outputs.voice.ServicesCommunicationsGatewayServiceLocation[]>;
    /**
