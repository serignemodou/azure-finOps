 ...
 * ```
 */
export declare class ServicesCommunicationsGatewayTestLine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicesCommunicationsGatewayTestLineState, opts?: pulumi.CustomResourceOptions): ServicesCommunicationsGatewayTestLine;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServicesCommunicationsGatewayTestLine;
    /**
     ...
     */
    readonly voiceServicesCommunicationsGatewayId: pulumi.Output<string>;
    /**
