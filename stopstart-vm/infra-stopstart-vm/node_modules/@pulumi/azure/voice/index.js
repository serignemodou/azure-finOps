...
exports.ServicesCommunicationsGatewayTestLine = exports.ServicesCommunicationsGateway = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.ServicesCommunicationsGateway = null;
utilities.lazyLoad(exports, ["ServicesCommunicationsGateway"], () => require("./servicesCommunicationsGateway"));
exports.ServicesCommunicationsGatewayTestLine = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:voice/servicesCommunicationsGateway:ServicesCommunicationsGateway":
                return new exports.ServicesCommunicationsGateway(name, undefined, { urn });
            case "azure:voice/servicesCommunicationsGatewayTestLine:ServicesCommunicationsGatewayTestLine":
                return new exports.ServicesCommunicationsGatewayTestLine(name, undefined, { urn });
            default:
