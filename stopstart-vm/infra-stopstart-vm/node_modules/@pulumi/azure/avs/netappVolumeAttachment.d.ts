 ...
 * ```
 */
export declare class NetappVolumeAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetappVolumeAttachmentState, opts?: pulumi.CustomResourceOptions): NetappVolumeAttachment;
    /**
