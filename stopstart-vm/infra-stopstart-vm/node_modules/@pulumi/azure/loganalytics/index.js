...
exports.WorkspaceTable = exports.StorageInsights = exports.SavedSearch = exports.QueryPack = exports.LinkedStorageAccount = exports.LinkedService = exports.DataSourceWindowsPerformanceCounter = exports.DataSourceWindowsEvent = exports.DataExportRule = exports.ClusterCustomerManagedKey = exports.Cluster = void 0;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:loganalytics/dataExportRule:DataExportRule":
                return new exports.DataExportRule(name, undefined, { urn });
            case "azure:loganalytics/dataSourceWindowsEvent:DataSourceWindowsEvent":
                return new exports.DataSourceWindowsEvent(name, undefined, { urn });
            case "azure:loganalytics/dataSourceWindowsPerformanceCounter:DataSourceWindowsPerformanceCounter":
                return new exports.DataSourceWindowsPerformanceCounter(name, undefined, { urn });
            ...
            case "azure:loganalytics/storageInsights:StorageInsights":
                return new exports.StorageInsights(name, undefined, { urn });
            case "azure:loganalytics/workspaceTable:WorkspaceTable":
                return new exports.WorkspaceTable(name, undefined, { urn });
            default:
