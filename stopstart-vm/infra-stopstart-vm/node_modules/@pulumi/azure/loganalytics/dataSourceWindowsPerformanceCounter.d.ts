 ...
 * ```
 */
export declare class DataSourceWindowsPerformanceCounter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSourceWindowsPerformanceCounterState, opts?: pulumi.CustomResourceOptions): DataSourceWindowsPerformanceCounter;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataSourceWindowsPerformanceCounter;
    /**
     * The friendly name of the performance counter.
     */
    readonly counterName: pulumi.Output<string>;
    /**
