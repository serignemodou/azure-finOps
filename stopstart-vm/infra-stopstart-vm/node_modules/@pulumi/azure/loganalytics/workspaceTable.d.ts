 ...
 */
export declare class WorkspaceTable extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkspaceTableState, opts?: pulumi.CustomResourceOptions): WorkspaceTable;
    /**
     * Returns true if the given object is an instance of WorkspaceTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceTable;
    /**
