...
export declare class Elasticsearch extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ElasticsearchState, opts?: pulumi.CustomResourceOptions): Elasticsearch;
    /**
     ...
     */
    readonly elasticCloudDeploymentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly logs: pulumi.Output<outputs.elasticcloud.ElasticsearchLogs | undefined>;
    /**
