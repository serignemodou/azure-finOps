 ...
 * ```
 */
export declare class VirtualMachineManagerServer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerServerState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerServer;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerServer;
    /**
