 ...
 * ```
 */
export declare class VirtualMachineManagerCloud extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerCloudState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerCloud;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerCloud;
    /**
