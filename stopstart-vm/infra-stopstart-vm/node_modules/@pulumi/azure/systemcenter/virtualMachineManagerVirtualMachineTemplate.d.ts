 ...
 * ```
 */
export declare class VirtualMachineManagerVirtualMachineTemplate extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerVirtualMachineTemplateState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerVirtualMachineTemplate;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerVirtualMachineTemplate;
    /**
     ...
     */
    readonly systemCenterVirtualMachineManagerServerInventoryItemId: pulumi.Output<string>;
    /**
