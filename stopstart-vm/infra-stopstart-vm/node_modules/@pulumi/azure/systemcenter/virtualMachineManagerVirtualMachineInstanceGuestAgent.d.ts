 ...
 * ```
 */
export declare class VirtualMachineManagerVirtualMachineInstanceGuestAgent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerVirtualMachineInstanceGuestAgentState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerVirtualMachineInstanceGuestAgent;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerVirtualMachineInstanceGuestAgent;
    /**
