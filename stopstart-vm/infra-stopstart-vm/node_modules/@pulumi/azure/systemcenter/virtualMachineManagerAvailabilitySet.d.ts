 ...
 * ```
 */
export declare class VirtualMachineManagerAvailabilitySet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerAvailabilitySetState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerAvailabilitySet;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerAvailabilitySet;
    /**
     ...
     */
    readonly systemCenterVirtualMachineManagerServerId: pulumi.Output<string>;
    /**
