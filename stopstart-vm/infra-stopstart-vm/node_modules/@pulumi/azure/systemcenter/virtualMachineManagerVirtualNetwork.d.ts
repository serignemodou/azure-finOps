 ...
 * ```
 */
export declare class VirtualMachineManagerVirtualNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMachineManagerVirtualNetworkState, opts?: pulumi.CustomResourceOptions): VirtualMachineManagerVirtualNetwork;
    /**
     ...
     */
    static isInstance(obj: any): obj is VirtualMachineManagerVirtualNetwork;
    /**
