 ...
 * * `Oracle.Database`: 2024-06-01
 */
export declare function getAdbsCharacterSetsOutput(args: GetAdbsCharacterSetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdbsCharacterSetsResult>;
/**
 * A collection of arguments for invoking getAdbsCharacterSets.
 */
