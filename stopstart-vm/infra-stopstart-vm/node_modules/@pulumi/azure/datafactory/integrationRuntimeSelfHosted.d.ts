...
export declare class IntegrationRuntimeSelfHosted extends pulumi.CustomResource {
     ...
     */
    readonly primaryAuthorizationKey: pulumi.Output<string>;
    /**
     ...
     */
    readonly secondaryAuthorizationKey: pulumi.Output<string>;
    /**
     ...
     */
    readonly selfContainedInteractiveAuthoringEnabled: pulumi.Output<boolean | undefined>;
    /**
