 ...
 * ```
 */
export declare class NetworkManagerAdminRuleCollection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerAdminRuleCollectionState, opts?: pulumi.CustomResourceOptions): NetworkManagerAdminRuleCollection;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerAdminRuleCollection;
    /**
     ...
     */
    readonly securityAdminConfigurationId: pulumi.Output<string>;
    /**
