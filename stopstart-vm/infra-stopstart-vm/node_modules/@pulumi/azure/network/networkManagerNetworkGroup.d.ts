 ...
 * ```
 */
export declare class NetworkManagerNetworkGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerNetworkGroupState, opts?: pulumi.CustomResourceOptions): NetworkManagerNetworkGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerNetworkGroup;
    /**
