 ...
 * ```
 */
export declare class IPGroupCIDR extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IPGroupCIDRState, opts?: pulumi.CustomResourceOptions): IPGroupCIDR;
    /**
     * Returns true if the given object is an instance of IPGroupCIDR.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IPGroupCIDR;
     ...
     */
    readonly ipGroupId: pulumi.Output<string>;
    /**
