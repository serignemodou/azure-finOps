 ...
 * ```
 */
export declare class NetworkManagerManagementGroupConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerManagementGroupConnectionState, opts?: pulumi.CustomResourceOptions): NetworkManagerManagementGroupConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerManagementGroupConnection;
    /**
