 ...
 * ```
 */
export declare class NetworkManagerVerifierWorkspace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerVerifierWorkspaceState, opts?: pulumi.CustomResourceOptions): NetworkManagerVerifierWorkspace;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerVerifierWorkspace;
    /**
