 ...
 * ```
 */
export declare class RouteServerBgpConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouteServerBgpConnectionState, opts?: pulumi.CustomResourceOptions): RouteServerBgpConnection;
    /**
     * Returns true if the given object is an instance of RouteServerBgpConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RouteServerBgpConnection;
    /**
