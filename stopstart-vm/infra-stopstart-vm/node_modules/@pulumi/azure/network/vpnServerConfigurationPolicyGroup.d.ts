 ...
 * ```
 */
export declare class VpnServerConfigurationPolicyGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnServerConfigurationPolicyGroupState, opts?: pulumi.CustomResourceOptions): VpnServerConfigurationPolicyGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is VpnServerConfigurationPolicyGroup;
    /**
     ...
     */
    readonly policies: pulumi.Output<outputs.network.VpnServerConfigurationPolicyGroupPolicy[]>;
    /**
