 ...
 * ```
 */
export declare class NetworkManagerConnectivityConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerConnectivityConfigurationState, opts?: pulumi.CustomResourceOptions): NetworkManagerConnectivityConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerConnectivityConfiguration;
    /**
     * One or more `appliesToGroup` blocks as defined below.
     */
    readonly appliesToGroups: pulumi.Output<outputs.network.NetworkManagerConnectivityConfigurationAppliesToGroup[]>;
    /**
     ...
     */
    readonly deleteExistingPeeringEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly globalMeshEnabled: pulumi.Output<boolean | undefined>;
    /**
     * A `hub` block as defined below.
     */
    readonly hub: pulumi.Output<outputs.network.NetworkManagerConnectivityConfigurationHub | undefined>;
    /**
     ...
     */
    readonly networkManagerId: pulumi.Output<string>;
    /**
