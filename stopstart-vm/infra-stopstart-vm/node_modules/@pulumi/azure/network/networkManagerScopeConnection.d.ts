 ...
 * ```
 */
export declare class NetworkManagerScopeConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerScopeConnectionState, opts?: pulumi.CustomResourceOptions): NetworkManagerScopeConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerScopeConnection;
    /**
     ...
     */
    readonly targetScopeId: pulumi.Output<string>;
    /**
