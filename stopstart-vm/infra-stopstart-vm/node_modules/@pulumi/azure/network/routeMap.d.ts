...
export declare class RouteMap extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouteMapState, opts?: pulumi.CustomResourceOptions): RouteMap;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.network.RouteMapRule[] | undefined>;
    /**
