 ...
 * ```
 */
export declare class NatGatewayPublicIpAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NatGatewayPublicIpAssociationState, opts?: pulumi.CustomResourceOptions): NatGatewayPublicIpAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is NatGatewayPublicIpAssociation;
    /**
