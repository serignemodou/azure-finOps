 ...
 * ```
 */
export declare class NetworkManagerSubscriptionConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerSubscriptionConnectionState, opts?: pulumi.CustomResourceOptions): NetworkManagerSubscriptionConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerSubscriptionConnection;
    /**
