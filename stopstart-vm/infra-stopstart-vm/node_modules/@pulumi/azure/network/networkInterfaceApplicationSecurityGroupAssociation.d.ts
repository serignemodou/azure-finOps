 ...
 * ```
 */
export declare class NetworkInterfaceApplicationSecurityGroupAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkInterfaceApplicationSecurityGroupAssociationState, opts?: pulumi.CustomResourceOptions): NetworkInterfaceApplicationSecurityGroupAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkInterfaceApplicationSecurityGroupAssociation;
    /**
     ...
     */
    readonly applicationSecurityGroupId: pulumi.Output<string>;
    /**
