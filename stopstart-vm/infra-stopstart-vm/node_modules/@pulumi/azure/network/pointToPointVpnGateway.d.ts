...
export declare class PointToPointVpnGateway extends pulumi.CustomResource {
     ...
     */
    readonly connectionConfigurations: pulumi.Output<outputs.network.PointToPointVpnGatewayConnectionConfiguration[]>;
    /**
     ...
     */
    readonly routingPreferenceInternetEnabled: pulumi.Output<boolean | undefined>;
    /**
