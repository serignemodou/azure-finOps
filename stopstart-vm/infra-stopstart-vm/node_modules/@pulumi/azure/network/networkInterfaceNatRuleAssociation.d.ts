 ...
 * ```
 */
export declare class NetworkInterfaceNatRuleAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkInterfaceNatRuleAssociationState, opts?: pulumi.CustomResourceOptions): NetworkInterfaceNatRuleAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkInterfaceNatRuleAssociation;
    /**
     ...
     */
    readonly natRuleId: pulumi.Output<string>;
    /**
