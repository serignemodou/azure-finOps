 ...
 * ```
 */
export declare class NetworkManagerStaticMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerStaticMemberState, opts?: pulumi.CustomResourceOptions): NetworkManagerStaticMember;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerStaticMember;
    /**
     ...
     */
    readonly networkGroupId: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetVirtualNetworkId: pulumi.Output<string>;
    /**
