 ...
 * ```
 */
export declare class NetworkManagerSecurityAdminConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerSecurityAdminConfigurationState, opts?: pulumi.CustomResourceOptions): NetworkManagerSecurityAdminConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkManagerSecurityAdminConfiguration;
    /**
