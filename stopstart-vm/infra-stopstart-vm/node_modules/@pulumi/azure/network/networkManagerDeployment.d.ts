 ...
 * ```
 */
export declare class NetworkManagerDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkManagerDeploymentState, opts?: pulumi.CustomResourceOptions): NetworkManagerDeployment;
    /**
     * Returns true if the given object is an instance of NetworkManagerDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkManagerDeployment;
    /**
     * A list of Network Manager Configuration IDs which should be aligned with `scopeAccess`.
     */
    readonly configurationIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly scopeAccess: pulumi.Output<string>;
    /**
