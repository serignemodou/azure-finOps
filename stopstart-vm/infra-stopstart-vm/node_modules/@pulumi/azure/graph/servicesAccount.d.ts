 ...
 * ```
 */
export declare class ServicesAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicesAccountState, opts?: pulumi.CustomResourceOptions): ServicesAccount;
    /**
     * Returns true if the given object is an instance of ServicesAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServicesAccount;
    /**
     ...
     * Billing Plan Id.
     */
    readonly billingPlanId: pulumi.Output<string>;
    /**
