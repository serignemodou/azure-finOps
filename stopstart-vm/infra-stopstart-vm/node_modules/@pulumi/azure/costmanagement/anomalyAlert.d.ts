 ...
 * ```
 */
export declare class AnomalyAlert extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnomalyAlertState, opts?: pulumi.CustomResourceOptions): AnomalyAlert;
    /**
     * Returns true if the given object is an instance of AnomalyAlert.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AnomalyAlert;
    /**
