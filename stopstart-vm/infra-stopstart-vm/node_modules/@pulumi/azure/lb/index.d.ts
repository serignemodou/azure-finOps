...
export declare const BackendAddressPool: typeof import("./backendAddressPool").BackendAddressPool;
...
export declare const BackendAddressPoolAddress: typeof import("./backendAddressPoolAddress").BackendAddressPoolAddress;
export { GetBackendAddressPoolArgs, GetBackendAddressPoolResult, GetBackendAddressPoolOutputArgs } from "./getBackendAddressPool";
export declare const getBackendAddressPool: typeof import("./getBackendAddressPool").getBackendAddressPool;
export declare const getBackendAddressPoolOutput: typeof import("./getBackendAddressPool").getBackendAddressPoolOutput;
export { GetLBArgs, GetLBResult, GetLBOutputArgs } from "./getLB";
export declare const getLB: typeof import("./getLB").getLB;
export declare const getLBOutput: typeof import("./getLB").getLBOutput;
export { GetLBOutboundRuleArgs, GetLBOutboundRuleResult, GetLBOutboundRuleOutputArgs } from "./getLBOutboundRule";
export declare const getLBOutboundRule: typeof import("./getLBOutboundRule").getLBOutboundRule;
export declare const getLBOutboundRuleOutput: typeof import("./getLBOutboundRule").getLBOutboundRuleOutput;
export { GetLBRuleArgs, GetLBRuleResult, GetLBRuleOutputArgs } from "./getLBRule";
export declare const getLBRule: typeof import("./getLBRule").getLBRule;
export declare const getLBRuleOutput: typeof import("./getLBRule").getLBRuleOutput;
...
export declare const NatPool: typeof import("./natPool").NatPool;
