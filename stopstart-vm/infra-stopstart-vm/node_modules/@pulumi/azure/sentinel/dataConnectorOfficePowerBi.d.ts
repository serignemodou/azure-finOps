 ...
 * ```
 */
export declare class DataConnectorOfficePowerBi extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorOfficePowerBiState, opts?: pulumi.CustomResourceOptions): DataConnectorOfficePowerBi;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorOfficePowerBi;
    /**
