 ...
 * ```
 */
export declare class DataConnectorAzureAdvancedThreadProtection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorAzureAdvancedThreadProtectionState, opts?: pulumi.CustomResourceOptions): DataConnectorAzureAdvancedThreadProtection;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorAzureAdvancedThreadProtection;
    /**
