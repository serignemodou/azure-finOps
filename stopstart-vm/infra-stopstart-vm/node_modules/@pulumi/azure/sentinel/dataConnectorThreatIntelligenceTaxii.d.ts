 ...
 * ```
 */
export declare class DataConnectorThreatIntelligenceTaxii extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorThreatIntelligenceTaxiiState, opts?: pulumi.CustomResourceOptions): DataConnectorThreatIntelligenceTaxii;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorThreatIntelligenceTaxii;
    /**
     * The API root URI of the TAXII server.
     */
    readonly apiRootUrl: pulumi.Output<string>;
    /**
     ...
     */
    readonly lookbackDate: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly pollingFrequency: pulumi.Output<string | undefined>;
    /**
