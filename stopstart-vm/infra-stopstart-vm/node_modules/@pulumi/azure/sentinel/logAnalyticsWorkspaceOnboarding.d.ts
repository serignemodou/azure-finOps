 ...
 * ```
 */
export declare class LogAnalyticsWorkspaceOnboarding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsWorkspaceOnboardingState, opts?: pulumi.CustomResourceOptions): LogAnalyticsWorkspaceOnboarding;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogAnalyticsWorkspaceOnboarding;
    /**
