...
exports.WatchlistItem = exports.Watchlist = exports.ThreatIntelligenceIndicator = exports.Metadata = exports.LogAnalyticsWorkspaceOnboarding = exports.getAlertRuleTemplateOutput = exports.getAlertRuleTemplate = exports.getAlertRuleAnomalyOutput = exports.getAlertRuleAnomaly = exports.getAlertRuleOutput = exports.getAlertRule = exports.DataConnectorThreatIntelligenceTaxii = exports.DataConnectorThreatIntelligence = exports.DataConnectorOfficePowerBi = exports.DataConnectorOfficeIrm = exports.DataConnectorOfficeAtp = exports.DataConnectorOffice365Project = exports.DataConnectorOffice365 = exports.DataConnectorMicrosoftThreatProtection = exports.DataConnectorMicrosoftThreatIntelligence = exports.DataConnectorMicrosoftDefenderAdvancedThreatProtection = exports.DataConnectorMicrosoftCloudAppSecurity = exports.DataConnectorIot = exports.DataConnectorDynamics365 = exports.DataConnectorAzureSecurityCenter = exports.DataConnectorAzureAdvancedThreadProtection = exports.DataConnectorAzureActiveDirectory = exports.DataConnectorAwsS3 = exports.DataConnectorAwsCloudTrail = exports.AutomationRule = exports.AuthomationRule = exports.AlertRuleThreatIntelligence = exports.AlertRuleScheduled = exports.AlertRuleNrt = exports.AlertRuleMsSecurityIncident = exports.AlertRuleMachineLearningBehaviorAnalytics = exports.AlertRuleFusion = exports.AlertRuleAnomalyDuplicate = exports.AlertRuleAnomalyBuiltIn = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.AlertRuleAnomalyBuiltIn = null;
utilities.lazyLoad(exports, ["AlertRuleAnomalyBuiltIn"], () => require("./alertRuleAnomalyBuiltIn"));
exports.AlertRuleAnomalyDuplicate = null;
utilities.lazyLoad(exports, ["AlertRuleAnomalyDuplicate"], () => require("./alertRuleAnomalyDuplicate"));
exports.AlertRuleFusion = null;
utilities.lazyLoad(exports, ["AlertRuleFusion"], () => require("./alertRuleFusion"));
exports.AlertRuleMachineLearningBehaviorAnalytics = null;
utilities.lazyLoad(exports, ["AlertRuleMachineLearningBehaviorAnalytics"], () => require("./alertRuleMachineLearningBehaviorAnalytics"));
exports.AlertRuleMsSecurityIncident = null;
utilities.lazyLoad(exports, ["AlertRuleMsSecurityIncident"], () => require("./alertRuleMsSecurityIncident"));
exports.AlertRuleNrt = null;
utilities.lazyLoad(exports, ["AlertRuleNrt"], () => require("./alertRuleNrt"));
exports.AlertRuleScheduled = null;
utilities.lazyLoad(exports, ["AlertRuleScheduled"], () => require("./alertRuleScheduled"));
exports.AlertRuleThreatIntelligence = null;
utilities.lazyLoad(exports, ["AlertRuleThreatIntelligence"], () => require("./alertRuleThreatIntelligence"));
exports.AuthomationRule = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "azure:sentinel/alertRuleAnomalyBuiltIn:AlertRuleAnomalyBuiltIn":
                return new exports.AlertRuleAnomalyBuiltIn(name, undefined, { urn });
            case "azure:sentinel/alertRuleAnomalyDuplicate:AlertRuleAnomalyDuplicate":
                return new exports.AlertRuleAnomalyDuplicate(name, undefined, { urn });
            case "azure:sentinel/alertRuleFusion:AlertRuleFusion":
                return new exports.AlertRuleFusion(name, undefined, { urn });
            case "azure:sentinel/alertRuleMachineLearningBehaviorAnalytics:AlertRuleMachineLearningBehaviorAnalytics":
                return new exports.AlertRuleMachineLearningBehaviorAnalytics(name, undefined, { urn });
            case "azure:sentinel/alertRuleMsSecurityIncident:AlertRuleMsSecurityIncident":
                return new exports.AlertRuleMsSecurityIncident(name, undefined, { urn });
            case "azure:sentinel/alertRuleNrt:AlertRuleNrt":
                return new exports.AlertRuleNrt(name, undefined, { urn });
            case "azure:sentinel/alertRuleScheduled:AlertRuleScheduled":
                return new exports.AlertRuleScheduled(name, undefined, { urn });
            case "azure:sentinel/alertRuleThreatIntelligence:AlertRuleThreatIntelligence":
                return new exports.AlertRuleThreatIntelligence(name, undefined, { urn });
            case "azure:sentinel/authomationRule:AuthomationRule":
                return new exports.AuthomationRule(name, undefined, { urn });
