 ...
 * ```
 */
export declare class DataConnectorDynamics365 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorDynamics365State, opts?: pulumi.CustomResourceOptions): DataConnectorDynamics365;
    /**
     * Returns true if the given object is an instance of DataConnectorDynamics365.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnectorDynamics365;
    /**
