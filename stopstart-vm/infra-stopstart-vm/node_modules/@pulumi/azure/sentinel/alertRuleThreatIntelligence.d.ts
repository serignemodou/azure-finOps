 ...
 * ```
 */
export declare class AlertRuleThreatIntelligence extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertRuleThreatIntelligenceState, opts?: pulumi.CustomResourceOptions): AlertRuleThreatIntelligence;
    /**
     ...
     */
    static isInstance(obj: any): obj is AlertRuleThreatIntelligence;
    /**
