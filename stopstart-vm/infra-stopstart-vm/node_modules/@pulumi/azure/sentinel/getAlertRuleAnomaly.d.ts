 ...
 * ```
 */
export declare function getAlertRuleAnomaly(args: GetAlertRuleAnomalyArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertRuleAnomalyResult>;
/**
 ...
 * ```
 */
export declare function getAlertRuleAnomalyOutput(args: GetAlertRuleAnomalyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertRuleAnomalyResult>;
/**
 * A collection of arguments for invoking getAlertRuleAnomaly.
 */
