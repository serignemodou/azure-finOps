 ...
 * ```
 */
export declare class DataConnectorAzureActiveDirectory extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorAzureActiveDirectoryState, opts?: pulumi.CustomResourceOptions): DataConnectorAzureActiveDirectory;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorAzureActiveDirectory;
    /**
