 ...
 * ```
 */
export declare class DataConnectorMicrosoftDefenderAdvancedThreatProtection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorMicrosoftDefenderAdvancedThreatProtectionState, opts?: pulumi.CustomResourceOptions): DataConnectorMicrosoftDefenderAdvancedThreatProtection;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorMicrosoftDefenderAdvancedThreatProtection;
    /**
