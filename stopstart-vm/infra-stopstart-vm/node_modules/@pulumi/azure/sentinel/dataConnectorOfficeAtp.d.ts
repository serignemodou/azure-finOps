 ...
 * ```
 */
export declare class DataConnectorOfficeAtp extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorOfficeAtpState, opts?: pulumi.CustomResourceOptions): DataConnectorOfficeAtp;
    /**
     * Returns true if the given object is an instance of DataConnectorOfficeAtp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnectorOfficeAtp;
    /**
