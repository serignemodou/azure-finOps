 ...
 */
export declare class AuthomationRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthomationRuleState, opts?: pulumi.CustomResourceOptions): AuthomationRule;
    /**
     ...
     */
    readonly actionIncidents: pulumi.Output<outputs.sentinel.AuthomationRuleActionIncident[] | undefined>;
    /**
     ...
     */
    readonly actionPlaybooks: pulumi.Output<outputs.sentinel.AuthomationRuleActionPlaybook[] | undefined>;
    /**
     ...
     */
    readonly conditionJson: pulumi.Output<string | undefined>;
    /**
