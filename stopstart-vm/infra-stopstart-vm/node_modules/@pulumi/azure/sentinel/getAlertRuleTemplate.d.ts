 ...
 * ```
 */
export declare function getAlertRuleTemplateOutput(args: GetAlertRuleTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertRuleTemplateResult>;
/**
 * A collection of arguments for invoking getAlertRuleTemplate.
 */
