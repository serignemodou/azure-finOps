 ...
 * ```
 */
export declare class DataConnectorMicrosoftThreatProtection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorMicrosoftThreatProtectionState, opts?: pulumi.CustomResourceOptions): DataConnectorMicrosoftThreatProtection;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataConnectorMicrosoftThreatProtection;
    /**
