 ...
 * ```
 */
export declare class DataConnectorOfficeIrm extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorOfficeIrmState, opts?: pulumi.CustomResourceOptions): DataConnectorOfficeIrm;
    /**
     * Returns true if the given object is an instance of DataConnectorOfficeIrm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnectorOfficeIrm;
    /**
