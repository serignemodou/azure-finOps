...
exports.WorkbookTemplate = exports.Workbook = exports.WebTest = exports.StandardWebTest = exports.SmartDetectionRule = exports.Insights = exports.getInsightsOutput = exports.getInsights = exports.ApiKey = exports.AnalyticsItem = void 0;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "azure:appinsights/insights:Insights":
                return new exports.Insights(name, undefined, { urn });
            case "azure:appinsights/smartDetectionRule:SmartDetectionRule":
                return new exports.SmartDetectionRule(name, undefined, { urn });
            case "azure:appinsights/standardWebTest:StandardWebTest":
                return new exports.StandardWebTest(name, undefined, { urn });
