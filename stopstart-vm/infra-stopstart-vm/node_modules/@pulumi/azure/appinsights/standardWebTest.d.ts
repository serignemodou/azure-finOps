 ...
 * ```
 */
export declare class StandardWebTest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StandardWebTestState, opts?: pulumi.CustomResourceOptions): StandardWebTest;
    /**
     * Returns true if the given object is an instance of StandardWebTest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StandardWebTest;
    /**
     ...
     */
    readonly request: pulumi.Output<outputs.appinsights.StandardWebTestRequest>;
    /**
     ...
     */
    readonly validationRules: pulumi.Output<outputs.appinsights.StandardWebTestValidationRules | undefined>;
    /**
