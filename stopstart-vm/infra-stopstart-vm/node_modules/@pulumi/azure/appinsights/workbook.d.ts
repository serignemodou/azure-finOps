...
export declare class Workbook extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkbookState, opts?: pulumi.CustomResourceOptions): Workbook;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.appinsights.WorkbookIdentity | undefined>;
    /**
     ...
     */
    readonly storageContainerId: pulumi.Output<string | undefined>;
    /**
