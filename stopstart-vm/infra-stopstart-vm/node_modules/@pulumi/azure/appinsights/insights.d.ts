...
export declare class Insights extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InsightsState, opts?: pulumi.CustomResourceOptions): Insights;
    /**
     * Returns true if the given object is an instance of Insights.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Insights;
    /**
     ...
     */
    readonly dailyDataCapInGb: pulumi.Output<number | undefined>;
    /**
     * Specifies if a notification email will be sent when the daily data volume cap is met. Defaults to `false`.
     */
    readonly dailyDataCapNotificationsDisabled: pulumi.Output<boolean | undefined>;
    /**
