...
export declare class Configuration extends pulumi.CustomResource {
     ...
     */
    readonly antimalware: pulumi.Output<outputs.automanage.ConfigurationAntimalware | undefined>;
    /**
     * Whether the automation account is enabled. Defaults to `false`.
     */
    readonly automationAccountEnabled: pulumi.Output<boolean | undefined>;
    /**
     * A `azureSecurityBaseline` block as defined below.
     */
    readonly azureSecurityBaseline: pulumi.Output<outputs.automanage.ConfigurationAzureSecurityBaseline | undefined>;
    /**
     * A `backup` block as defined below.
     */
    readonly backup: pulumi.Output<outputs.automanage.ConfigurationBackup | undefined>;
    /**
     * Whether the boot diagnostics are enabled. Defaults to `false`.
     */
    readonly bootDiagnosticsEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Whether the defender for cloud is enabled. Defaults to `false`.
     */
    readonly defenderForCloudEnabled: pulumi.Output<boolean | undefined>;
    /**
     * Whether the guest configuration is enabled. Defaults to `false`.
     */
    readonly guestConfigurationEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly logAnalyticsEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly statusChangeAlertEnabled: pulumi.Output<boolean | undefined>;
