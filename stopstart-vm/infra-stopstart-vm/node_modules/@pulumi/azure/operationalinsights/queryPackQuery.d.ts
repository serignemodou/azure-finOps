 ...
 * ```
 */
export declare class QueryPackQuery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QueryPackQueryState, opts?: pulumi.CustomResourceOptions): QueryPackQuery;
    /**
     * Returns true if the given object is an instance of QueryPackQuery.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is QueryPackQuery;
    /**
     * The additional properties that can be set for the Log Analytics Query Pack Query.
     */
    readonly additionalSettingsJson: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly resourceTypes: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly solutions: pulumi.Output<string[] | undefined>;
    /**
